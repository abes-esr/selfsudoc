dojo.provide("dijit.nls.dijit-all_cs");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.cs");
dojo.nls.colors.cs = {
    ...
    "darkslategrey": "tmavá břidlicová šedá",
    "peru": "karamelová",
...
dojo.provide("dijit._editor.nls.commands.cs");
dijit._editor.nls.commands.cs = {
...
dojo.provide("dijit.form.nls.ComboBox.cs");
dijit.form.nls.ComboBox.cs = {"previousMessage": "Předchozí volby", "nextMessage": "Další volby"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.cs");
dijit._editor.nls.FontChoice.cs = {
    "1": "extra malé",
    "2": "velmi malé",
    "formatBlock": "Formát",
    "3": "malé",
...
dojo.provide("dijit._editor.nls.LinkDialog.cs");
dijit._editor.nls.LinkDialog.cs = {
    "text": "Popis:",
...
dojo.cldr.nls.gregorian.cs = {
    ...
    "months-format-abbr": ["ledna", "února", "března", "dubna", "května", "června", "července", "srpna", "září", "října", "listopadu", "prosince"],
