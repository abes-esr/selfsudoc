dojo.provide("dijit.nls.dijit-all_zh-tw");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.zh_tw");
dojo.nls.colors.zh_tw = {
    "lightsteelblue": "淡鐵藍色",
    "orangered": "橙紅色",
    "midnightblue": "午夜藍",
    "cadetblue": "軍服藍",
...
dojo.provide("dijit._editor.nls.commands.zh_tw");
...
dojo.provide("dijit.form.nls.validate.zh_tw");
dijit.form.nls.validate.zh_tw = {
    "rangeMessage": "此值超出範圍。",
...
dojo.provide("dijit.form.nls.ComboBox.zh_tw");
dijit.form.nls.ComboBox.zh_tw = {"previousMessage": "前一個選擇項", "nextMessage": "其他選擇項"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.zh_tw");
dijit._editor.nls.FontChoice.zh_tw = {
    "1": "最小",
    "2": "較小",
    "formatBlock": "格式",
    "3": "小",
...
dojo.provide("dijit._editor.nls.LinkDialog.zh_tw");
dijit._editor.nls.LinkDialog.zh_tw = {
    "text": "說明：",
...
dojo.provide("dojo.cldr.nls.number.zh_tw");
dojo.cldr.nls.number.zh_tw = {
    "decimalFormat": "#,##0.###",
    "group": ",",
    "scientificFormat": "#E0",
    "percentFormat": "#,##0%",
...
dojo.provide("dojo.cldr.nls.currency.zh_tw");
dojo.cldr.nls.currency.zh_tw = {
...
dojo.provide("dojo.cldr.nls.gregorian.zh_tw");
dojo.cldr.nls.gregorian.zh_tw = {
    ...
    "days-standAlone-abbr": ["週日", "週一", "週二", "週三", "週四", "週五", "週六"],
    "dateFormat-short": "yy/M/d",
    "dateFormatItem-yMMMEd": "y年M月d日EEE",
    "dateFormatItem-Md": "M/d",
    "dateFormatItem-yMEd": "yyyy/M/d（EEE）",
    "dateTimeAvailableFormats": ["d日（E）", "H:mm", "H:mm:ss", "M-d（E）", "MM/dd", "M/d", "yyyy/M", "yyyy/M/d（EEE）", "yyyy年M月", "yyyy年M月", "yyyy/MM", "MMMMdd日", "MMMd日", "MM-dd", "M-d", "d日", "mm:ss", "mm:ss", "yyyy年", "yyyy-M", "yyyy年M月d日，E", "yyyy年MMM", "yyyy年MMMd日EEE", "yyyy年MMMM", "yyyy年QQQ", "y年QQQ", "yy-MM", "yy年MMM", "yy年第Q季度", "yyyy年", "yyyy年M月", "yyyy年MMMM"],
    ...
    "dateFormatItem-M": "L",
    "days-standAlone-wide": ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"],
