dojo.provide("dijit.nls.dijit-all_nb");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.nb");
dojo.nls.colors.nb = {
...
dojo.provide("dijit._editor.nls.commands.nb");
dijit._editor.nls.commands.nb = {
...
dojo.provide("dijit.form.nls.ComboBox.nb");
dijit.form.nls.ComboBox.nb = {"previousMessage": "Tidligere valg", "nextMessage": "Flere valg"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.nb");
dijit._editor.nls.FontChoice.nb = {
    "1": "xx-liten",
    "2": "x-liten",
    "formatBlock": "Format",
    "3": "liten",
...
dojo.provide("dijit._editor.nls.LinkDialog.nb");
dijit._editor.nls.LinkDialog.nb = {
    "text": "Beskrivelse:",
...
dojo.cldr.nls.gregorian.nb = {
    ...
    "months-standAlone-wide": ["januar", "februar", "mars", "april", "mai", "juni", "juli", "august", "september", "oktober", "november", "desember"],
    ...
    "months-format-abbr": ["jan.", "feb.", "mars", "apr.", "mai", "juni", "juli", "aug.", "sep.", "okt.", "nov.", "des."],
    ...
    "months-standAlone-abbr": ["jan.", "feb.", "mars", "apr.", "mai", "juni", "juli", "aug.", "sep.", "okt.", "nov.", "des."],
