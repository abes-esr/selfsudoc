dojo.provide("dijit.nls.dijit-all_ca");
...
dijit.form.nls.ComboBox.ca = {"previousMessage": "Opcions anteriors", "nextMessage": "Més opcions"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.ca");
dijit._editor.nls.FontChoice.ca = {
    "1": "xx-petit",
    "2": "x-petit",
    "formatBlock": "Format",
    "3": "petit",
...
dojo.provide("dijit._editor.nls.LinkDialog.ca");
dijit._editor.nls.LinkDialog.ca = {
    "text": "Descipció:",
...
dojo.cldr.nls.gregorian.ca = {
    ...
    "months-format-wide": ["de gener", "de febrer", "de març", "d’abril", "de maig", "de juny", "de juliol", "d’agost", "de setembre", "d’octubre", "de novembre", "de desembre"],
    ...
    "field-hour": "hora",
    "months-format-abbr": ["de gen.", "de febr.", "de març", "d’abr.", "de maig", "de juny", "de jul.", "d’ag.", "de set.", "d’oct.", "de nov.", "de des."],
    ...
    "months-standAlone-abbr": ["gen.", "febr.", "març", "abr.", "maig", "juny", "jul.", "ag.", "set.", "oct.", "nov.", "des."],
    "quarters-format-abbr": ["1T", "2T", "3T", "4T"],
    "quarters-standAlone-wide": ["1r trimestre", "2n trimestre", "3r trimestre", "4t trimestre"],
    "dateFormatItem-M": "L",
    ...
    "eraNames": ["aC", "dC"],
    "days-format-narrow": ["g", "l", "t", "c", "j", "v", "s"],
    "field-month": "mes",
    "days-standAlone-narrow": ["g", "l", "t", "c", "j", "v", "s"],
