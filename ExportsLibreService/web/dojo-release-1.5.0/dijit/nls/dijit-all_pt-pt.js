...
dojo.nls.colors.pt_pt = {
    ...
    "lightslategrey": "cinzento ardósia claro",
    "grey": "cinzento",
    ...
    "darkslategrey": "cinzento ardósia escuro",
    "peru": "peru",
...
dojo.provide("dijit._editor.nls.commands.pt_pt");
dijit._editor.nls.commands.pt_pt = {
...
dojo.provide("dijit.form.nls.validate.pt_pt");
dijit.form.nls.validate.pt_pt = {
...
dojo.provide("dijit.form.nls.ComboBox.pt_pt");
dijit.form.nls.ComboBox.pt_pt = {"previousMessage": "Opções anteriores", "nextMessage": "Mais opções"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.pt_pt");
dijit._editor.nls.FontChoice.pt_pt = {
    "1": "xxs",
    "2": "xs",
    "formatBlock": "Formato",
    "3": "small",
...
dojo.provide("dijit._editor.nls.LinkDialog.pt_pt");
dijit._editor.nls.LinkDialog.pt_pt = {
    "text": "Descrição:",
...
dojo.provide("dojo.cldr.nls.number.pt_pt");
dojo.cldr.nls.number.pt_pt = {
    "currencyFormat": "#,##0.00 ¤",
    "group": " ",
    "percentSign": "%",
    "exponential": "E",
...
dojo.provide("dojo.cldr.nls.currency.pt_pt");
dojo.cldr.nls.currency.pt_pt = {
...
dojo.provide("dojo.cldr.nls.gregorian.pt_pt");
dojo.cldr.nls.gregorian.pt_pt = {
    "quarters-standAlone-wide": ["1.º trimestre", "2.º trimestre", "3.º trimestre", "4.º trimestre"],
    "quarters-format-abbr": ["1.º trimestre", "2.º trimestre", "3.º trimestre", "4.º trimestre"],
    "dayPeriods-standAlone-wide-am": "a.m.",
    "dateFormat-medium": "d 'de' MMM 'de' yyyy",
    "quarters-standAlone-abbr": ["1.º trimestre", "2.º trimestre", "3.º trimestre", "4.º trimestre"],
    "dayPeriods-standAlone-abbr-pm": "p.m.",
    "dateFormatItem-hm": "h:mm",
    "months-standAlone-wide": ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"],
    "dayPeriods-standAlone-abbr-am": "a.m.",
    "dayPeriods-format-wide-pm": "Depois do meio-dia",
    "months-standAlone-abbr": ["Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"],
    ...
    "days-standAlone-wide": ["Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sábado"],
    "months-format-abbr": ["Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"],
    "days-standAlone-abbr": ["Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sábado"],
    ...
    "quarters-format-wide": ["1.º trimestre", "2.º trimestre", "3.º trimestre", "4.º trimestre"],
    "dayPeriods-standAlone-wide-pm": "p.m.",
    "days-format-abbr": ["Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sábado"],
