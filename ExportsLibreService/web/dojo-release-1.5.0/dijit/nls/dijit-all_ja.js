dojo.provide("dijit.nls.dijit-all_ja");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.ja");
dojo.nls.colors.ja = {
...
dojo.provide("dijit._editor.nls.commands.ja");
dijit._editor.nls.commands.ja = {
    "removeFormat": "形式の除去",
    "copy": "コピー",
    "paste": "貼り付け",
    "selectAll": "すべて選択",
...
dojo.provide("dijit.form.nls.ComboBox.ja");
dijit.form.nls.ComboBox.ja = {"previousMessage": "以前の選択項目", "nextMessage": "追加の選択項目"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.ja");
dijit._editor.nls.FontChoice.ja = {
    "1": "超極小",
    "2": "極小",
    "formatBlock": "フォーマット",
    "3": "小",
...
dojo.provide("dijit._editor.nls.LinkDialog.ja");
dijit._editor.nls.LinkDialog.ja = {
    "text": "説明:",
