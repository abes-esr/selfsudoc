dojo.provide("dijit.nls.dijit-all_sl");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.sl");
dojo.nls.colors.sl = {
    ...
    "lightslategrey": "svetlo skrilasto siva",
    "grey": "siva",
    ...
    "darkred": "temno rdeča",
    "darkslategrey": "temno skrilasto siva",
    "peru": "perujska",
...
dojo.provide("dijit._editor.nls.commands.sl");
dijit._editor.nls.commands.sl = {
...
dojo.provide("dijit.form.nls.ComboBox.sl");
dijit.form.nls.ComboBox.sl = {"previousMessage": "Prejšnje možnosti", "nextMessage": "Dodatne možnosti"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.sl");
dijit._editor.nls.FontChoice.sl = {
    "1": "xx-majhno",
    "2": "x-majhno",
    "formatBlock": "Oblika",
    "3": "majhno",
...
dojo.provide("dijit._editor.nls.LinkDialog.sl");
dijit._editor.nls.LinkDialog.sl = {
    "text": "Opis:",
...
dojo.cldr.nls.gregorian.sl = {
    ...
    "days-standAlone-wide": ["nedelja", "ponedeljek", "torek", "sreda", "četrtek", "petek", "sobota"],
    ...
    "months-standAlone-abbr": ["jan", "feb", "mar", "apr", "maj", "jun", "jul", "avg", "sep", "okt", "nov", "dec"],
    "field-day-relative+0": "Danes",
    "field-day-relative+1": "Jutri",
    "days-standAlone-narrow": ["n", "p", "t", "s", "č", "p", "s"],
    "eraAbbr": ["pr. n. št.", "po Kr."],
    ...
    "quarters-standAlone-wide": ["1. četrtletje", "2. četrtletje", "3. četrtletje", "4. četrtletje"],
    "dateFormatItem-ms": "mm:ss",
    "field-year": "Leto",
    "months-standAlone-wide": ["januar", "februar", "marec", "april", "maj", "junij", "julij", "avgust", "september", "oktober", "november", "december"],
    "field-week": "Teden",
    ...
    "quarters-format-wide": ["1. četrtletje", "2. četrtletje", "3. četrtletje", "4. četrtletje"],
    "days-format-wide": ["nedelja", "ponedeljek", "torek", "sreda", "četrtek", "petek", "sobota"],
    "eraNarrow": ["pr. n. št.", "po Kr."],
