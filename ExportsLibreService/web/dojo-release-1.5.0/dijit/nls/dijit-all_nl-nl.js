dojo.provide("dijit.nls.dijit-all_nl-nl");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.nl_nl");
dojo.nls.colors.nl_nl = {
...
dojo.provide("dijit._editor.nls.commands.nl_nl");
dijit._editor.nls.commands.nl_nl = {
...
dojo.provide("dijit.form.nls.ComboBox.nl_nl");
dijit.form.nls.ComboBox.nl_nl = {"previousMessage": "Eerdere opties", "nextMessage": "Meer opties"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.nl_nl");
dijit._editor.nls.FontChoice.nl_nl = {
    "1": "xx-klein",
    "2": "x-klein",
    "formatBlock": "Opmaak",
    "3": "klein",
...
dojo.provide("dijit._editor.nls.LinkDialog.nl_nl");
dijit._editor.nls.LinkDialog.nl_nl = {
    "text": "Beschrijving:",
...
dojo.cldr.nls.gregorian.nl_nl = {
    ...
    "days-standAlone-wide": ["zondag", "maandag", "dinsdag", "woensdag", "donderdag", "vrijdag", "zaterdag"],
    ...
    "months-standAlone-abbr": ["jan.", "feb.", "mrt.", "apr.", "mei", "jun.", "jul.", "aug.", "sep.", "okt.", "nov.", "dec."],
    ...
    "field-year": "Jaar",
    "field-week": "Week",
    "months-standAlone-wide": ["januari", "februari", "maart", "april", "mei", "juni", "juli", "augustus", "september", "oktober", "november", "december"],
