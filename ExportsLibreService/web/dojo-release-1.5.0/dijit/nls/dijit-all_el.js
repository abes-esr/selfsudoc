dojo.provide("dijit.nls.dijit-all_el");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.el");
dojo.nls.colors.el = {
    ...
    "lightslategrey": "ανοιχτό μεταλλικό γκρι",
    "grey": "γκρι",
    ...
    "darkslategrey": "σκούρο μεταλλικό γκρι",
    "peru": "περού",
    "lightgrey": "ανοιχτό γκρι",
...
dojo.provide("dijit._editor.nls.commands.el");
dijit._editor.nls.commands.el = {
...
dojo.provide("dijit.form.nls.ComboBox.el");
dijit.form.nls.ComboBox.el = {"previousMessage": "Προηγούμενες επιλογές", "nextMessage": "Περισσότερες επιλογές"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.el");
dijit._editor.nls.FontChoice.el = {
    "1": "xx-μικρά",
    "2": "x-μικρά",
    "formatBlock": "Μορφή",
    "3": "μικρά",
...
dojo.provide("dijit._editor.nls.LinkDialog.el");
dijit._editor.nls.LinkDialog.el = {
    "text": "Περιγραφή:",
...
dojo.cldr.nls.gregorian.el = {
    ...
    "quarters-standAlone-wide": ["1ο τρίμηνο", "2ο τρίμηνο", "3ο τρίμηνο", "4ο τρίμηνο"],
    "dateFormatItem-HHmmss": "HH:mm:ss",
    "dateFormatItem-M": "L",
    "days-standAlone-wide": ["Κυριακή", "Δευτέρα", "Τρίτη", "Τετάρτη", "Πέμπτη", "Παρασκευή", "Σάββατο"],
    ...
    "days-standAlone-abbr": ["Κυρ", "Δευ", "Τρι", "Τετ", "Πεμ", "Παρ", "Σαβ"],
    "dateFormatItem-d": "d",
