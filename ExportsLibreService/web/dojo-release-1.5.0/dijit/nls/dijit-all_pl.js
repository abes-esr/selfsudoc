dojo.provide("dijit.nls.dijit-all_pl");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.pl");
dojo.nls.colors.pl = {
    ...
    "lightslategrey": "jasny łupkowy szary",
    "grey": "szary",
    ...
    "darkslategrey": "ciemny łupkowy szary",
    "peru": "jasnobrązowy",
...
dojo.provide("dijit._editor.nls.commands.pl");
dijit._editor.nls.commands.pl = {
...
dojo.provide("dijit.form.nls.ComboBox.pl");
dijit.form.nls.ComboBox.pl = {"previousMessage": "Poprzednie wybory", "nextMessage": "Więcej wyborów"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.pl");
dijit._editor.nls.FontChoice.pl = {
    "1": "najmniejsza",
    "2": "mniejsza",
    "formatBlock": "Format",
    "3": "mała",
...
dojo.provide("dijit._editor.nls.LinkDialog.pl");
dijit._editor.nls.LinkDialog.pl = {
    "text": "Opis:",
...
dojo.cldr.nls.gregorian.pl = {
    "months-format-narrow": ["s", "l", "m", "k", "m", "c", "l", "s", "w", "p", "l", "g"],
    ...
    "months-format-wide": ["stycznia", "lutego", "marca", "kwietnia", "maja", "czerwca", "lipca", "sierpnia", "września", "października", "listopada", "grudnia"],
    ...
    "months-standAlone-wide": ["styczeń", "luty", "marzec", "kwiecień", "maj", "czerwiec", "lipiec", "sierpień", "wrzesień", "październik", "listopad", "grudzień"],
    "timeFormat-short": "HH:mm",
    "quarters-format-wide": ["I kwartał", "II kwartał", "III kwartał", "IV kwartał"],
    ...
    "months-standAlone-abbr": ["sty", "lut", "mar", "kwi", "maj", "cze", "lip", "sie", "wrz", "paź", "lis", "gru"],
    "quarters-format-abbr": ["K1", "K2", "K3", "K4"],
    "quarters-standAlone-wide": ["I kwartał", "II kwartał", "III kwartał", "IV kwartał"],
    "dateFormatItem-M": "L",
    "days-standAlone-wide": ["niedziela", "poniedziałek", "wtorek", "środa", "czwartek", "piątek", "sobota"],
    ...
    "days-standAlone-abbr": ["niedz.", "pon.", "wt.", "śr.", "czw.", "pt.", "sob."],
