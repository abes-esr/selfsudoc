dojo.provide("dijit.nls.dijit-all_it-it");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.it_it");
dojo.nls.colors.it_it = {
...
dojo.provide("dijit._editor.nls.commands.it_it");
dijit._editor.nls.commands.it_it = {
...
dojo.provide("dijit.form.nls.validate.it_it");
dijit.form.nls.validate.it_it = {
...
dojo.provide("dijit.form.nls.ComboBox.it_it");
dijit.form.nls.ComboBox.it_it = {"previousMessage": "Scelte precedenti", "nextMessage": "Altre scelte"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.it_it");
dijit._editor.nls.FontChoice.it_it = {
    "1": "xx-small",
    "2": "x-small",
    "formatBlock": "Formato",
    "3": "small",
...
dojo.provide("dijit._editor.nls.LinkDialog.it_it");
dijit._editor.nls.LinkDialog.it_it = {
    "text": "Descrizione:",
...
dojo.provide("dojo.cldr.nls.number.it_it");
dojo.cldr.nls.number.it_it = {
    "decimalFormat": "#,##0.###",
    "group": ".",
    "scientificFormat": "#E0",
    "percentFormat": "#,##0%",
...
dojo.provide("dojo.cldr.nls.currency.it_it");
dojo.cldr.nls.currency.it_it = {
...
dojo.provide("dojo.cldr.nls.gregorian.it_it");
dojo.cldr.nls.gregorian.it_it = {
    "months-format-narrow": ["G", "F", "M", "A", "M", "G", "L", "A", "S", "O", "N", "D"],
    ...
    "months-standAlone-wide": ["Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"],
    ...
    "months-standAlone-abbr": ["gen", "feb", "mar", "apr", "mag", "giu", "lug", "ago", "set", "ott", "nov", "dic"],
    "quarters-format-abbr": ["T1", "T2", "T3", "T4"],
    "quarters-standAlone-wide": ["1o trimestre", "2o trimestre", "3o trimestre", "4o trimestre"],
    "dateFormatItem-M": "L",
    "days-standAlone-wide": ["Domenica", "Lunedì", "Martedì", "Mercoledì", "Giovedì", "Venerdì", "Sabato"],
