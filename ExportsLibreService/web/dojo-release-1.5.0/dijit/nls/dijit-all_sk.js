dojo.provide("dijit.nls.dijit-all_sk");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.sk");
dojo.nls.colors.sk = {
    ...
    "lightslategrey": "bridlicová sivá svetlá",
    "grey": "sivá",
    ...
    "darkslategrey": "bridlicová sivá tmavá",
    "peru": "peru",
...
dojo.provide("dijit._editor.nls.commands.sk");
dijit._editor.nls.commands.sk = {
...
dojo.provide("dijit.form.nls.ComboBox.sk");
dijit.form.nls.ComboBox.sk = {"previousMessage": "Predchádzajúce voľby", "nextMessage": "Ďalšie voľby"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.sk");
dijit._editor.nls.FontChoice.sk = {
    "1": "xx-small",
    "2": "x-small",
    "formatBlock": "Formát",
    "3": "small",
...
dojo.provide("dijit._editor.nls.LinkDialog.sk");
dijit._editor.nls.LinkDialog.sk = {
    "text": "Opis:",
...
dojo.cldr.nls.gregorian.sk = {
    ...
    "days-standAlone-wide": ["nedeľa", "pondelok", "utorok", "streda", "štvrtok", "piatok", "sobota"],
    "months-standAlone-narrow": ["j", "f", "m", "a", "m", "j", "j", "a", "s", "o", "n", "d"],
    "field-era": "Éra",
    "field-hour": "Hodina",
    "dayPeriods-format-wide-am": "dopoludnia",
    "timeFormat-full": "H:mm:ss zzzz",
    "months-standAlone-abbr": ["jan", "feb", "mar", "apr", "máj", "jún", "júl", "aug", "sep", "okt", "nov", "dec"],
    ...
    "quarters-standAlone-wide": ["1. štvrťrok", "2. štvrťrok", "3. štvrťrok", "4. štvrťrok"],
    "dateFormatItem-yMMMM": "LLLL y",
    "dateFormatItem-ms": "mm:ss",
    "field-year": "Rok",
    "months-standAlone-wide": ["január", "február", "marec", "apríl", "máj", "jún", "júl", "august", "september", "október", "november", "december"],
    "field-week": "Týždeň",
    ...
    "months-format-wide": ["januára", "februára", "marca", "apríla", "mája", "júna", "júla", "augusta", "septembra", "októbra", "novembra", "decembra"],
    "dateFormatItem-d": "d.",
