dojo.provide("dijit.nls.dijit-all_sv");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.sv");
dojo.nls.colors.sv = {
    ...
    "lightslategrey": "ljust skiffergrått",
    "grey": "grått",
    ...
    "darkred": "mörkrött",
    "darkslategrey": "mörkt skiffergrått",
    "peru": "peru",
    "lightgrey": "ljusgrått",
...
dojo.provide("dijit._editor.nls.commands.sv");
dijit._editor.nls.commands.sv = {
...
dojo.provide("dijit.form.nls.ComboBox.sv");
dijit.form.nls.ComboBox.sv = {"previousMessage": "Föregående alternativ", "nextMessage": "Fler alternativ"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.sv");
dijit._editor.nls.FontChoice.sv = {
...
dojo.provide("dijit._editor.nls.LinkDialog.sv");
dijit._editor.nls.LinkDialog.sv = {
    "text": "Beskrivning:",
...
dojo.cldr.nls.gregorian.sv = {
    ...
    "months-standAlone-wide": ["januari", "februari", "mars", "april", "maj", "juni", "juli", "augusti", "september", "oktober", "november", "december"],
    ...
    "quarters-standAlone-wide": ["1:a kvartalet", "2:a kvartalet", "3:e kvartalet", "4:e kvartalet"],
    "dateFormatItem-M": "L",
    "days-standAlone-wide": ["söndag", "måndag", "tisdag", "onsdag", "torsdag", "fredag", "lördag"],
    ...
    "days-standAlone-abbr": ["sön", "mån", "tis", "ons", "tors", "fre", "lör"],
    "dateFormatItem-d": "d",
