dojo.provide("dijit.nls.dijit-all_de-de");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.de_de");
dojo.nls.colors.de_de = {
...
dojo.provide("dijit._editor.nls.commands.de_de");
dijit._editor.nls.commands.de_de = {
...
dojo.provide("dijit.form.nls.validate.de_de");
dijit.form.nls.validate.de_de = {
...
dojo.provide("dijit.form.nls.ComboBox.de_de");
dijit.form.nls.ComboBox.de_de = {"previousMessage": "Vorherige Auswahl", "nextMessage": "Weitere Auswahlmöglichkeiten"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.de_de");
dijit._editor.nls.FontChoice.de_de = {
    "1": "XXS",
    "2": "XS",
    "formatBlock": "Format",
    "3": "S",
...
dojo.provide("dijit._editor.nls.LinkDialog.de_de");
dijit._editor.nls.LinkDialog.de_de = {
    "text": "Beschreibung:",
...
dojo.provide("dojo.cldr.nls.number.de_de");
dojo.cldr.nls.number.de_de = {
    "group": ".",
    "percentSign": "%",
    "exponential": "E",
    "percentFormat": "#,##0 %",
...
dojo.provide("dojo.cldr.nls.currency.de_de");
dojo.cldr.nls.currency.de_de = {
...
dojo.provide("dojo.cldr.nls.gregorian.de_de");
dojo.cldr.nls.gregorian.de_de = {
    ...
    "months-standAlone-wide": ["Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"],
    ...
    "months-standAlone-abbr": ["Jan", "Feb", "Mär", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"],
    "quarters-format-abbr": ["Q1", "Q2", "Q3", "Q4"],
    "quarters-standAlone-wide": ["1. Quartal", "2. Quartal", "3. Quartal", "4. Quartal"],
    "dateFormatItem-M": "L",
    "days-standAlone-wide": ["Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"],
