dojo.provide("dijit.nls.dijit-all_ko-kr");
dojo.provide("dojo.nls.colors");
dojo.nls.colors._built = true;
dojo.provide("dojo.nls.colors.ko_kr");
dojo.nls.colors.ko_kr = {
    ...
    "lightslategrey": "라이트 슬레이트 그레이(light slate gray)",
    "grey": "그레이(gray)",
    ...
    "darkslategrey": "다크 슬레이트 그레이(dark slate gray)",
    "peru": "페루(peru)",
    "lightgrey": "라이트 그레이(light gray)",
...
dojo.provide("dijit._editor.nls.commands.ko_kr");
dijit._editor.nls.commands.ko_kr = {
    "removeFormat": "형식 제거",
    "copy": "복사",
    "paste": "붙여넣기",
    "selectAll": "모두 선택",
...
dojo.provide("dijit.form.nls.ComboBox.ko_kr");
dijit.form.nls.ComboBox.ko_kr = {"previousMessage": "이전 선택사항", "nextMessage": "기타 선택사항"};
dojo.provide("dijit._editor.nls.FontChoice");
dijit._editor.nls.FontChoice._built = true;
dojo.provide("dijit._editor.nls.FontChoice.ko_kr");
dijit._editor.nls.FontChoice.ko_kr = {
    "1": "가장 작게",
    "2": "조금 작게",
    "formatBlock": "서식",
    "3": "작게",
...
dojo.provide("dijit._editor.nls.LinkDialog.ko_kr");
dijit._editor.nls.LinkDialog.ko_kr = {
    "text": "설명:",
...
dojo.cldr.nls.gregorian.ko_kr = {
    "months-format-narrow": ["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"],
    "field-weekday": "요일",
    ...
    "quarters-standAlone-wide": ["제 1/4분기", "제 2/4분기", "제 3/4분기", "제 4/4분기"],
    "dateFormatItem-HHmmss": "HH:mm:ss",
    "dateFormatItem-M": "L",
    "days-standAlone-wide": ["일요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일"],
