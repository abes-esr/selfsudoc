...
if (!dojo._hasResource["dijit.Tree"]) {
    ...
    dojo.declare("dijit._TreeNode", [dijit._Widget, dijit._Templated, dijit._Container, dijit._Contained, dijit._CssStateMixin], {
        ...
        _setExpando: function (_d) {
            var _e = ["dijitTreeExpandoLoading", "dijitTreeExpandoOpened", "dijitTreeExpandoClosed", "dijitTreeExpandoLeaf"],
                _f = ["*", "-", "+", "*"], idx = _d ? 0 : (this.isExpandable ? (this.isExpanded ? 1 : 2) : 3);
        ...
        setChildItems: function (_11) {
            ...
            if (_11 && _11.length > 0) {
                ...
                dojo.forEach(_11, function (_16) {
                    ...
                    if (!_18) {
                        _18 = this.tree._createTreeNode({
                            item: _16,
                            tree: _12,
                            isExpandable: _13.mayHaveChildren(_16),
                            label: _12.getLabel(_16),
                            tooltip: _12.getTooltip(_16),
                            dir: _12.dir,
                            lang: _12.lang,
        ...
        _load: function () {
            this.model.getRoot(dojo.hitch(this, function (_26) {
                var rn = (this.rootNode = this.tree._createTreeNode({
                    ...
                    tree: this,
                    isExpandable: true,
                    label: this.label || this.getLabel(_26),
