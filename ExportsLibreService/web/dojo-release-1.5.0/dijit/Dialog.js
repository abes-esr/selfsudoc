    ...
    dojo.declare("dijit._DialogBase", [dijit._Templated, dijit.form._FormMixin, dijit._DialogMixin, dijit._CssStateMixin], {
        ...
        _setup: function () {
            ...
            if (this.titleBar && this.draggable) {
                this._moveable = (dojo.isIE == 6) ? new dojo.dnd.TimedMoveable(_2, {handle: this.titleBar}) : new dojo.dnd.Moveable(_2, {
            ...
            this._fadeIn = dojo.fadeIn({
                node: _2, duration: this.duration, beforeBegin: dojo.hitch(this, function () {
            ...
            this._fadeOut = dojo.fadeOut({
                node: _2, duration: this.duration, onEnd: dojo.hitch(this, function () {
        ...
        _position: function () {
            if (!dojo.hasClass(dojo.body(), "dojoMove")) {
                var _8 = this.domNode, _9 = dojo.window.getBox(), p = this._relativePosition,
                    bb = p ? null : dojo._getBorderBox(_8), l = Math.floor(_9.l + (p ? p.x : (_9.w - bb.w) / 2)),
                    t = Math.floor(_9.t + (p ? p.y : (_9.h - bb.h) / 2));
