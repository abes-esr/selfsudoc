...
if (!dojo._hasResource["dijit.Menu"]) {
    ...
    dojo.declare("dijit.Menu", dijit._MenuBase, {
        ...
        _openMyself: function (_20) {
            ...
            if (_23) {
                if (_22) {
                    var od = _21.ownerDocument, ifc = dojo.position(_22, true), win = this._iframeContentWindow(_22),
                        _24 = dojo.withGlobal(win, "_docScroll", dojo);
                    var cs = dojo.getComputedStyle(_22), tp = dojo._toPixelValue,
                        _25 = (dojo.isIE && dojo.isQuirks ? 0 : tp(_22, cs.paddingLeft)) + (dojo.isIE && dojo.isQuirks ? tp(_22, cs.borderLeftWidth) : 0),
                        top = (dojo.isIE && dojo.isQuirks ? 0 : tp(_22, cs.paddingTop)) + (dojo.isIE && dojo.isQuirks ? tp(_22, cs.borderTopWidth) : 0);
