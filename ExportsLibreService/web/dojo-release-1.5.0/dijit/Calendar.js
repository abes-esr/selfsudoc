    ...
    dojo.declare("dijit.Calendar", [dijit._Widget, dijit._Templated, dijit._CssStateMixin], {
        ...
        _setValueAttr: function (_3) {
            if (!this.value || this.dateFuncObj.compare(_3, this.value)) {
                ...
                dojo.attr(this.domNode, "aria-label", this.dateLocaleModule.format(_3, {
                    selector: "date",
                    formatLength: "full"
                }));
                this._populateGrid();
        ...
        _populateGrid: function () {
            ...
            _6.setDate(1);
            var _7 = _6.getDay(), _8 = this.dateFuncObj.getDaysInMonth(_6),
                _9 = this.dateFuncObj.getDaysInMonth(this.dateFuncObj.add(_6, "month", -1)),
                _a = new this.dateClassObj(), _b = dojo.cldr.supplemental.getFirstDayOfWeek(this.lang);
            if (_b > _7) {
                _b -= 7;
            }
            dojo.query(".dijitCalendarDateTemplate", this.domNode).forEach(function (_c, i) {
                ...
                var _11 = dojo.query(".dijitCalendarDateLabel", _c)[0],
                    _12 = _d.getDateLocalized ? _d.getDateLocalized(this.lang) : _d.getDate();
            ...
            dojo.forEach(["previous", "current", "next"], function (_15) {
                d.setFullYear(y++);
                this._setText(this[_15 + "YearLabelNode"], this.dateLocaleModule.format(d, {
                    selector: "year",
                    locale: this.lang
                }));
            }, this);
