    ...
    dojo.declare("dijit.tree.TreeStoreModel", null, {
        ...
        getRoot: function (_3, _4) {
            if (this.root) {
                ...
                this.store.fetch({
                    query: this.query, onComplete: dojo.hitch(this, function (_5) {
                        if (_5.length != 1) {
        ...
        newItem: function (_18, _19, _1a) {
            ...
            if (this.newItemIdAttr && _18[this.newItemIdAttr]) {
                this.fetchItemByIdentity({
                    identity: _18[this.newItemIdAttr], scope: this, onItem: function (_1c) {
                        if (_1c) {
