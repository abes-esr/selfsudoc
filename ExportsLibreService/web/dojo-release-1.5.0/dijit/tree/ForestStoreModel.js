...
if (!dojo._hasResource["dijit.tree.ForestStoreModel"]) {
    ...
    dojo.declare("dijit.tree.ForestStoreModel", dijit.tree.TreeStoreModel, {
        rootId: "$root$", rootLabel: "ROOT", query: null, constructor: function (_1) {
            ...
            if (_3 === this.root) {
                if (this.root.children) {
                    ...
                    this.store.fetch({
                        query: this.query, onComplete: dojo.hitch(this, function (_6) {
            ...
            this.store.fetch({
                query: this.query, onComplete: dojo.hitch(this, function (_18) {
