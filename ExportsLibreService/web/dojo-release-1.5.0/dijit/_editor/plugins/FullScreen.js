        ...
        _setFullScreen: function (_b) {
            ...
            if (_b) {
                ...
                this._origState = {
                    width: _f.width || "",
                    height: _f.height || "",
                    top: dojo.style(_e, "top") || "",
                    left: dojo.style(_e, "left") || "",
                    position: dojo.style(_e, "position") || "static",
                ...
                this._origiFrameState = {
                    ...
                    width: _11.width || "auto",
                    height: _11.height || "auto",
                    zIndex: _11.zIndex || ""
                };
                ...
                dojo.style(ed.iframe, {
                    ...
                    width: "100%",
                    zIndex: this.zIndex,
                    backgroundColor: bc !== "transparent" && bc !== "rgba(0, 0, 0, 0)" ? bc : "white"
                });
