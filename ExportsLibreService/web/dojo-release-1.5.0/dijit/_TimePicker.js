...
if (!dojo._hasResource["dijit._TimePicker"]) {
    ...
    dojo.declare("dijit._TimePicker", [dijit._Widget, dijit._Templated], {
        ...
        _getFilteredNodes: function (_7, _8, _9) {
            var _a = [], n, i = _7, _b = this._maxIncrement + Math.abs(i), _c = _9 ? -1 : 1, _d = _9 ? 1 : 0,
                _e = _9 ? 0 : 1;
            do {
                i = i - _d;
        ...
        handleKey: function (e) {
            ...
            if (e.keyChar || e.charOrCode === dk.BACKSPACE || e.charOrCode == dk.DELETE) {
                ...
                if (e.charOrCode == dk.DOWN_ARROW || e.charOrCode == dk.UP_ARROW) {
                    ...
                    var _2c = this.timeMenu,
                        tgt = this._highlighted_option || dojo.query("." + this.baseClass + "ItemSelected", _2c)[0];
                    if (!tgt) {
