    ...
    dojo.declare("dijit.form._FormSelectWidget", dijit.form._FormValueWidget, {
        ...
        _addOptionForItem: function (_24) {
            ...
            if (!_25.isItemLoaded(_24)) {
                _25.loadItem({
                    item: _24, onComplete: function (i) {
        ...
        _fillContent: function () {
            ...
            if (!_28) {
                _28 = this.options = this.srcNodeRef ? dojo.query(">", this.srcNodeRef).map(function (_29) {
                    ...
                    return {
                        value: _29.getAttribute("value"),
                        label: String(_29.innerHTML),
                        selected: _29.getAttribute("selected") || false,
                        disabled: _29.getAttribute("disabled") || false
                    };
                }, this) : [];
            }
            if (!this.value) {
