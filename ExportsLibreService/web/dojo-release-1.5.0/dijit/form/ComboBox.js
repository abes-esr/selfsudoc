...
if (!dojo._hasResource["dijit.form.ComboBox"]) {
    ...
    dojo.declare("dijit.form.ComboBox", [dijit.form.ValidationTextBox, dijit.form.ComboBoxMixin], {
        _setValueAttr: function (_4a, _4b, _4c) {
            this.item = null;
            if (!_4a) {
                _4a = "";
            }
    ...
    dojo.declare("dijit.form._ComboBoxDataStore", null, {
        constructor: function (_4d) {
            ...
            var _56 = dojo.data.util.filter.patternToRegExp(_53.query.name, _53.queryOptions.ignoreCase),
                _57 = dojo.query("> option", this.root).filter(function (_58) {
