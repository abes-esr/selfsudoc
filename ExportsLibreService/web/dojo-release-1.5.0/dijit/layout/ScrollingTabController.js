...
if (!dojo._hasResource["dijit.layout.ScrollingTabController"]) {
    ...
    dojo.declare("dijit.layout.ScrollingTabController", dijit.layout.TabController, {
        ...
        _getTabsWidth: function () {
            ...
            if (_c.length) {
                var _d = _c[this.isLeftToRight() ? 0 : _c.length - 1].domNode,
                    _e = _c[this.isLeftToRight() ? _c.length - 1 : 0].domNode;
        ...
        _getScrollBounds: function () {
            var _15 = this.getChildren(), _16 = dojo.style(this.scrollNode, "width"),
                _17 = dojo.style(this.containerNode, "width"), _18 = _17 - _16, _19 = this._getTabsWidth();
            if (_15.length && _19 > _16) {
                return {
                    min: this.isLeftToRight() ? 0 : _15[_15.length - 1].domNode.offsetLeft,
                    max: this.isLeftToRight() ? (_15[_15.length - 1].domNode.offsetLeft + dojo.style(_15[_15.length - 1].domNode, "width")) - _16 : _18
                };
            } else {
        ...
        _getScrollForSelectedTab: function () {
            var w = this.scrollNode, n = this._selectedTab, _1b = dojo.style(this.scrollNode, "width"),
                _1c = this._getScrollBounds();
        ...
        createSmoothScroll: function (x) {
            ...
            var _1e = this, w = this.scrollNode, _1f = new dojo._Animation({
