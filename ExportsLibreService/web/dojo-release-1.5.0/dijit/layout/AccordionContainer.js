...
if (!dojo._hasResource["dijit.layout.AccordionContainer"]) {
    ...
    dojo.declare("dijit.layout.AccordionContainer", dijit.layout.StackContainer, {
        ...
        layout: function () {
            ...
            var _4 = _3._wrapperWidget.domNode, _5 = dojo._getMarginExtents(_4), _6 = dojo._getPadBorderExtents(_4),
                _7 = this._contentBox;
            var _8 = 0;
        ...
        _setupChild: function (_a) {
            _a._wrapperWidget = new dijit.layout._AccordionInnerContainer({
                contentWidget: _a,
        ...
        _transition: function (_10, _11, _12) {
            ...
            if (_10) {
                ...
                if (_12) {
                    ...
                    _13.push(dojo.animateProperty({
                        node: _15,
                        duration: this.duration,
                        properties: {height: {start: 1, end: this._getTargetHeight(_15)}},
                        onEnd: function () {
            ...
            if (_11) {
                ...
                if (_12) {
                    ...
                    _13.push(dojo.animateProperty({
                        node: _17,
                        duration: this.duration,
                        properties: {height: {start: this._getTargetHeight(_17), end: 1}},
                        onEnd: function () {
    ...
    dojo.declare("dijit.layout._AccordionInnerContainer", [dijit._Widget, dijit._CssStateMixin], {
        ...
        buildRendering: function () {
            ...
            this.button = _1b._buttonWidget = (new cls({
                contentWidget: _1b,
                label: _1b.title,
                title: _1b.tooltip,
                dir: _1b.dir,
                lang: _1b.lang,
                iconClass: _1b.iconClass,
                id: _1b.id + "_button",
                parent: this.parent
