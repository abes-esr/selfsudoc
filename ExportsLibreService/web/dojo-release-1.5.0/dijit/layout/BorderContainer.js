...
if (!dojo._hasResource["dijit.layout.BorderContainer"]) {
    ...
    dojo.declare("dijit.layout.BorderContainer", dijit.layout._LayoutWidget, {
        ...
        _layoutChildren: function (_13, _14) {
            ...
            dojo.mixin(_1e, {
                top: pe.t + _16 + _28 + "px",
                left: pe.l + _18 + _29 + "px",
                right: pe.r + _19 + _2a + "px",
                bottom: pe.b + _17 + _2b + "px"
            });
            ...
            if (_36) {
                ...
                var _3c = !_13 || (/top|bottom/.test(_13) && this.design != "sidebar"),
                    _3d = !_13 || (/left|right/.test(_13) && this.design == "sidebar"),
                    _3e = {center: true, left: _3c, right: _3c, top: _3d, bottom: _3d};
    ...
    dojo.declare("dijit.layout._Splitter", [dijit._Widget, dijit._Templated], {
        ...
        _computeMaxSize: function () {
            ...
            var _44 = {
                ...
                leading: "trailing",
                trailing: "leading"
            }, _45 = this.container["_" + _44[this.region]];
        ...
        _startDrag: function (e) {
            ...
            var _47 = this._factor, max = this._computeMaxSize(), min = this.child.minSize || 20, _48 = this.horizontal,
                _49 = _48 ? "pageY" : "pageX", _4a = e[_49], _4b = this.domNode.style, dim = _48 ? "h" : "w",
                _4c = dojo.marginBox(this.child.domNode)[dim], _4d = this.region,
                _4e = parseInt(this.domNode.style[_4d], 10), _4f = this._resize, _50 = this.child.domNode,
                _51 = dojo.hitch(this.container, this.container._layoutChildren), de = dojo.doc;
    ...
    dojo.declare("dijit.layout._Gutter", [dijit._Widget, dijit._Templated], {
        templateString: "<div class=\"dijitGutter\" waiRole=\"presentation\"></div>", postCreate: function () {
            this.horizontal = /top|bottom/.test(this.region);
