...
if (!dojo._hasResource["dijit.layout._LayoutWidget"]) {
    ...
    dojo.declare("dijit.layout._LayoutWidget", [dijit._Widget, dijit._Container, dijit._Contained], {
        baseClass: "dijitLayoutContainer", isLayoutContainer: true, postCreate: function () {
            ...
            this._contentBox = {
                l: dojo._toPixelValue(_4, cs.paddingLeft),
                t: dojo._toPixelValue(_4, cs.paddingTop),
                w: bb.w - pe.w,
                h: bb.h - pe.h
            };
            this.layout();
    ...
    dijit.layout.marginBox2contentBox = function (_9, mb) {
        ...
        return {
            l: dojo._toPixelValue(_9, cs.paddingLeft),
            t: dojo._toPixelValue(_9, cs.paddingTop),
            w: mb.w - (me.w + pb.w),
            h: mb.h - (me.h + pb.h)
        };
    };
