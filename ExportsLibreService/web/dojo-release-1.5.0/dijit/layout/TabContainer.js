...
if (!dojo._hasResource["dijit.layout.TabContainer"]) {
    ...
    dojo.declare("dijit.layout.TabContainer", dijit.layout._TabContainerBase, {
        useMenu: true, useSlider: true, controllerWidget: "", _makeController: function (_1) {
            var _2 = this.baseClass + "-tabs" + (this.doLayout ? "" : " dijitTabNoLayout"),
                _3 = dojo.getObject(this.controllerWidget);
            return new _3({
                id: this.id + "_tablist",
                dir: this.dir,
                lang: this.lang,
