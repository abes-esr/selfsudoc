...
if (!dojo._hasResource["dijit._base.popup"]) {
    ...
    dijit.popup = {
        _stack: [], _beginZIndex: 1000, _idGen: 1, moveOffScreen: function (_1) {
            ...
            var _5 = this._stack, _6 = _4.popup,
                _7 = _4.orient || ((_4.parent ? _4.parent.isLeftToRight() : dojo._isBodyLtr()) ? {
                    "BL": "TL",
                    "BR": "TR",
                    "TL": "BL",
                    "TR": "BR"
                } : {"BR": "TR", "BL": "TL", "TR": "BR", "TL": "BL"}), _8 = _4.around,
                id = (_4.around && _4.around.id) ? (_4.around.id + "_dropdown") : ("popup_" + this._idGen++);
            ...
            dojo.attr(_9, {
                id: id,
                style: {zIndex: this._beginZIndex + _5.length},
                "class": "dijitPopup " + (_6.baseClass || _6["class"] || "").split(" ")[0] + "Popup",
                dijitPopupParent: _4.parent ? _4.parent.id : ""
            });
            ...
            _5.push({
                ...
                widget: _6,
                parent: _4.parent,
                onExecute: _4.onExecute,
                onCancel: _4.onCancel,
                onClose: _4.onClose,
                handlers: _c
            });
            if (_6.onOpen) {
