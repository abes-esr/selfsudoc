...
if (!dojo._hasResource["dijit._base.place"]) {
    ...
    dijit._place = function (_7, _8, _9) {
        ...
        dojo.some(_8, function (_c) {
            ...
            _f.display = _10;
            _f.visibility = _11;
            var _12 = Math.max(_a.l, _d.charAt(1) == "L" ? _e.x : (_e.x - mb.w)),
                _13 = Math.max(_a.t, _d.charAt(0) == "T" ? _e.y : (_e.y - mb.h)),
                _14 = Math.min(_a.l + _a.w, _d.charAt(1) == "L" ? (_12 + mb.w) : _e.x),
                _15 = Math.min(_a.t + _a.h, _d.charAt(0) == "T" ? (_13 + mb.h) : _e.y), _16 = _14 - _12,
                _17 = _15 - _13, _18 = (mb.w - _16) + (mb.h - _17);
    ...
    dijit._placeOnScreenAroundRect = function (_23, x, y, _24, _25, _26, _27) {
        ...
        for (var _29 in _26) {
            _28.push({
                aroundCorner: _29,
                corner: _26[_29],
                pos: {x: x + (_29.charAt(1) == "L" ? 0 : _24), y: y + (_29.charAt(0) == "T" ? 0 : _25)}
            });
        }
