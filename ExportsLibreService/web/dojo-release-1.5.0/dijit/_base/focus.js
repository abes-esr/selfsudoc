...
if (!dojo._hasResource["dijit._base.focus"]) {
    ...
    dojo.mixin(dijit, {
        _curFocus: null, _prevFocus: null, isCollapsed: function () {
            ...
            return {
                node: _9,
                bookmark: (_9 == dijit._curFocus) && dojo.withGlobal(_8 || dojo.global, dijit.getBookmark),
                openedForWindow: _8
            };
        }, focus: function (_a) {
            if (!_a) {
            ...
            var _b = "node" in _a ? _a.node : _a, _c = _a.bookmark, _d = _a.openedForWindow,
                _e = _c ? _c.isCollapsed : false;
            if (_b) {
