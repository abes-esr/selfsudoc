...
if (!dojo._hasResource["dojox.gfx3d.scheduler"]) {
    ...
    dojo.declare("dojox.gfx3d.scheduler.BinarySearchTree", null, {
        constructor: function (_6, _7) {
            ...
            var _a = 0.5, o = _9(_8), v = dojox.gfx3d.vector, n = this.normal, a = this.orient,
                _b = dojox.gfx3d.scheduler.BinarySearchTree;
    ...
    dojo.mixin(dojox.gfx3d.drawer, {
        conservative: function (_13, _14, _15) {
