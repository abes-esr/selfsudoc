...
if (!dojo._hasResource["dojox.gfx3d.lighting"]) {
    ...
    (function () {
        ...
        dojo.mixin(dojox.gfx3d.lighting, {
            black: function () {
                ...
                for (var i = 0; i < _6.length; ++i) {
                    var l = _6[i], h = _1.normalize(_1.add(_1.normalize(l.direction), v)),
                        s = Math.pow(Math.max(0, _1.dot(_4, h)), 1 / _5);
                ...
                for (var i = 0; i < _9.length; ++i) {
                    var l = _9[i], r = _1.reflect(_1.scale(-1, _1.normalize(v)), _7),
                        s = Math.pow(Math.max(0, _1.dot(r, _1.normalize(l.direction))), _8);
                    c = _1.addColor(c, _1.scaleColor(s, l.color));
                }
                return _1.saturateColor(c);
            }
        ...
        dojo.declare("dojox.gfx3d.lighting.Model", null, {
            constructor: function (_a, _b, _c, _d) {
                ...
                var _16 = _1.scaleColor(_14.Ka, this.ambient), _17 = _1.saturate(-4 * _1.dot(_13, this.incident)),
                    _18 = _1.scaleColor(_17 * _14.Kd, _1.diffuse(_13, this.lights)),
                    _19 = _1.scaleColor(_15.a, _1.multiplyColor(_15, _1.addColor(_16, _18)));
                _19.a = _15.a;
                ...
                var v = _1.scale(-1, this.incident), _1d, _1e, _1f = _1.scaleColor(_1b.Ka, this.ambient),
                    _20 = _1.saturate(-4 * _1.dot(_1a, this.incident));
                if ("phong" in _1b) {
                ...
                var v = _1.scale(-1, this.incident), _24, _25, _26 = _1.scaleColor(_22.Ka, this.ambient),
                    _27 = _1.saturate(-4 * _1.dot(_21, this.incident)),
                    _28 = _1.scaleColor(_27 * _22.Kd, _1.diffuse(_21, this.lights));
                if ("phong" in _22) {
                ...
                var _2c = _1.scaleColor(_2a.Ka, this.ambient), _2d = _1.saturate(-4 * _1.dot(_29, this.incident)),
                    _2e = _1.scaleColor(_2d * _2a.Kd, _1.diffuse(_29, this.lights)),
                    _2f = _1.scaleColor(_2b.a, _1.multiplyColor(_2b, _1.addColor(_2c, _2e))),
                    _30 = _1.addColor(this.npr_cool, _1.scaleColor(this.npr_alpha, _2f)),
                    _31 = _1.addColor(this.npr_warm, _1.scaleColor(this.npr_beta, _2f)),
                    d = (1 + _1.dot(this.incident, _29)) / 2,
                    _2f = _1.scaleColor(this.npr_scale, _1.addColor(_2f, _1.mixColor(_30, _31, d)));
                _2f.a = _2b.a;
    ...
    dojox.gfx3d.lighting.finish = {
        defaults: {Ka: 0.1, Kd: 0.6, Ks: 0, roughness: 0.05},
        dull: {Ka: 0.1, Kd: 0.6, Ks: 0.5, roughness: 0.15},
        shiny: {Ka: 0.1, Kd: 0.6, Ks: 1, roughness: 0.001},
        glossy: {Ka: 0.1, Kd: 0.6, Ks: 1, roughness: 0.0001},
        phong_dull: {Ka: 0.1, Kd: 0.6, Ks: 0.5, phong: 0.5, phong_size: 1},
        phong_shiny: {Ka: 0.1, Kd: 0.6, Ks: 1, phong: 1, phong_size: 200},
        phong_glossy: {Ka: 0.1, Kd: 0.6, Ks: 1, phong: 1, phong_size: 300},
        luminous: {Ka: 1, Kd: 0, Ks: 0, roughness: 0.05},
        metalA: {Ka: 0.35, Kd: 0.3, Ks: 0.8, roughness: 1 / 20},
        metalB: {Ka: 0.3, Kd: 0.4, Ks: 0.7, roughness: 1 / 60},
        metalC: {Ka: 0.25, Kd: 0.5, Ks: 0.8, roughness: 1 / 80},
        metalD: {Ka: 0.15, Kd: 0.6, Ks: 0.8, roughness: 1 / 100},
        metalE: {Ka: 0.1, Kd: 0.7, Ks: 0.8, roughness: 1 / 120}
    };
}
