...
if (!dojo._hasResource["dojox.gfx3d.object"]) {
    ...
    dojo.declare("dojox.gfx3d.Edges", dojox.gfx3d.Object, {
        constructor: function () {
            ...
            this.object = dojox.gfx.makeParameters(this.object, (_18 instanceof Array) ? {
                points: _18,
                style: _19
            } : _18);
            return this;
    ...
    dojo.declare("dojox.gfx3d.Orbit", dojox.gfx3d.Object, {
        constructor: function () {
            ...
            var _22 = dojo.map(_20, function (_23) {
                return {
                    x: this.center.x + this.radius * Math.cos(_23),
                    y: this.center.y + this.radius * Math.sin(_23),
                    z: this.center.z
                };
            }, this.object);
    ...
    dojo.declare("dojox.gfx3d.Quads", dojox.gfx3d.Object, {
        constructor: function () {
            ...
            this.object = dojox.gfx.makeParameters(this.object, (_44 instanceof Array) ? {
                points: _44,
                style: _45
            } : _44);
            return this;
    ...
    dojo.declare("dojox.gfx3d.Cylinder", dojox.gfx3d.Object, {
        constructor: function () {
            ...
            var _5a = dojo.map(_58, function (_5b) {
                return {
                    x: this.center.x + this.radius * Math.cos(_5b),
                    y: this.center.y + this.radius * Math.sin(_5b),
                    z: this.center.z
                };
            }, this.object);
            ...
            var top = dojox.gfx3d.matrix.multiplyPoint(m, dojox.gfx3d.vector.sum(this.object.center, {
                x: 0,
                y: 0,
                z: this.object.height
            }));
            ...
            var c = this.cache, v = dojox.gfx3d.vector, m = dojox.gfx.matrix, _62 = [c.center, c.top],
                _63 = v.substract(c.top, c.center);
            if (v.dotProduct(_63, this.renderer.lighting.incident) > 0) {
                _62 = [c.top, c.center];
                _63 = v.substract(c.center, c.top);
            }
            var _64 = this.renderer.lighting[this.fillStyle.type](_63, this.fillStyle.finish, this.fillStyle.color),
            ...
            if (c.rx > 0 && c.ry > 0) {
                this.shape.createEllipse({
                    ...
                    rx: c.rx,
                    ry: c.ry
                }).setFill(_64).setStroke(this.strokeStyle).applyTransform(m.rotateAt(c.theta, _62[1]));
            }
        }
    });
