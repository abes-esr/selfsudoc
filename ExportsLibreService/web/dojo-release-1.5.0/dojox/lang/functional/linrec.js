    ...
    (function () {
        ...
        df.linrec = function (_4, _5, _6, _7) {
            ...
            var _b = df.keys(_8), _c = df.keys(_9),
                f = new Function([], "var _x=arguments,_y,_r".concat(_b.length ? "," + _b.join(",") : "", _c.length ? ",_t=_x.callee," + _c.join(",") : t ? ",_t=_x.callee" : "", ";for(;!", cs, ";_x=", bs, "){_y={p:_y,a:_x}}_r=", ts, ";for(;_y;_y=_y.p){_r=", as, "}return _r"));
            if (c) {
                f.c = c;
            }
            if (t) {
