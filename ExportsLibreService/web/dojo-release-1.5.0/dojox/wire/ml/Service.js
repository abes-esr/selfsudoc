...
if (!dojo._hasResource["dojox.wire.ml.Service"]) {
    ...
    dojo.declare("dojox.wire.ml.RestHandler", null, {
        contentType: "text/plain", handleAs: "text", bind: function (_7, _8, _9, _a) {
            _7 = _7.toUpperCase();
            var _b = this;
            var _c = {
                url: this._getUrl(_7, _8, _a),
    ...
    dojo.declare("dojox.wire.ml.XmlHandler", dojox.wire.ml.RestHandler, {
        contentType: "text/xml", handleAs: "xml", _getContent: function (_1a, _1b) {
            var _1c = null;
            if (_1a == "POST" || _1a == "PUT") {
                var p = _1b[0];
                if (p) {
    ...
    dojo.declare("dojox.wire.ml.JsonHandler", dojox.wire.ml.RestHandler, {
        contentType: "text/json", handleAs: "json", headers: {"Accept": "*/json"}, _getContent: function (_20, _21) {
            var _22 = null;
            if (_20 == "POST" || _20 == "PUT") {
