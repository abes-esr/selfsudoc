...
if (!dojo._hasResource["dojox.form.FilePickerTextBox"]) {
    ...
    dojo.declare("dojox.form.FilePickerTextBox", [dijit.form.ValidationTextBox, dijit._HasDropDown], {
                    ...
                    var fx = dojo.hitch(this, function () {
                        ...
                        if (_18 && ((_12.length > idx + 1 && _18.children) || (!_18.children))) {
                            ...
                            if (_19 && _12.length === idx + 1) {
                                ...
                                if (this._menuFocus) {
                                    this.dropDown._updateClass(this._menuFocus, "Item", {
                                        "Hover": false,
                                        "Focus": false
                                    });
                                }
