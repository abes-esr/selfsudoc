...
if (!dojo._hasResource["dojox.form.RangeSlider"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.form._RangeSliderMixin", null, {
            value: [0, 100], postMixInProperties: function () {
                ...
                var s = dojo.getComputedStyle(this.sliderBarContainer),
                    c = dojo._getContentBox(this.sliderBarContainer, s), _e = this.discreteValues,
                    _f = !_d ? this.value[0] : this.value[1];
                if (_e <= 1 || _e == Infinity) {
                ...
                var _11 = dojo.coords(this.sliderBarContainer, true), bar = dojo.coords(this.progressBar, true),
                    _12 = e[this._mousePixelCoord] - _11[this._startingPixelCoord], _13 = bar[this._startingPixelCount],
                    _14 = _13 + bar[this._pixelCount], _15 = this._isReversed() ? _12 <= _13 : _12 >= _14,
                    p = this._isReversed() ? _11[this._pixelCount] - _12 : _12;
        ...
        dojo.declare("dijit.form._SliderBarMover", dojo.dnd.Mover, {
            onMouseMove: function (e) {
                ...
                var _3f = e[_3c._mousePixelCoord] - _3d[_3c._startingPixelCoord] - _3e,
                    _40 = _3f + bar[_3c._pixelCount];
                pixelValues = [_3f, _40];
                pixelValues.sort(_2);
                if (pixelValues[0] <= 0) {
                    pixelValues[0] = 0;
