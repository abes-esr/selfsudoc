    ...
    dojo.declare("dojox.form.FileUploader", [dijit._Widget, dijit._Templated, dijit._Contained], {
        ...
        uploadHTML: function () {
            ...
            var dfd = dojo.io.iframe.send({
                url: this.uploadUrl, form: this._formNode, handleAs: "json", error: dojo.hitch(this, function (err) {
        ...
        createFlashUploader: function () {
            ...
            var _2c = {
                ...
                params: {scale: "noscale", wmode: "opaque"}
            };
        ...
        getStyle: function (_32) {
            ...
            if (url) {
                o.bi = {
                    url: url,
                    rp: dojo.style(_32, "backgroundRepeat"),
                    pos: escape(dojo.style(_32, "backgroundPosition"))
                };
                if (!o.bi.pos) {
