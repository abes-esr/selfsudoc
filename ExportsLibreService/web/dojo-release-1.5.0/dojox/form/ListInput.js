...
if (!dojo._hasResource["dojox.form.ListInput"]) {
    ...
    dojo.declare("dojox.form.ListInput", [dijit.form._FormValueWidget], {
        ...
        _onItemClose: function (_f) {
            ...
            if (this.useAnim) {
                var _10 = dojo.fadeOut({
                    node: _f.domNode,
                    duration: this.duration,
                    easing: this.easingOut,
                    onEnd: dojo.hitch(this, "_destroyItem", _f)
                }).play();
            } else {
    ...
    dojo.declare("dojox.form._ListInputInputItem", [dijit._Widget, dijit._Templated], {
        ...
        _editBox: null,
        _handleKeyDown: null,
        attributeMap: {value: {node: "labelNode", type: "innerHTML"}},
        ...
        _createInlineEditBox: function () {
            ...
            this._editBox = new dijit.InlineEditBox({
                ...
                editorParams: {regExp: this.regExp}
            }, this.labelNode);
    ...
    dojo.declare("dojox.form._ListInputInputBox", [dijit.form.ValidationTextBox], {
        minWidth: 50, intermediateChanges: true, regExp: ".*", _sizer: null, onChange: function (_35) {
            this.inherited(arguments);
            if (this._sizer === null) {
