...
if (!dojo._hasResource["dojox.image.ThumbnailPicker"]) {
    ...
    dojo.declare("dojox.image.ThumbnailPicker", [dijit._Widget, dijit._Templated], {
        imageStore: null,
        request: null,
        size: 500,
        thumbHeight: 75,
        ...
        setDataStore: function (_6, _7, _8) {
            this.reset();
            this.request = {
                query: {}, start: _7.start || 0, count: _7.count || 10, onBegin: dojo.hitch(this, function (_9) {
                    this._maxPhotos = _9;
                })
            };
            if (_7.query) {
        ...
        _showThumbs: function (_20) {
            ...
            if (this.isScrollable) {
                ...
                dojox.fx.smoothScroll({
                    ...
                    onEnd: dojo.hitch(this, "_checkLoad", img, _20)
                }).play(10);
            } else {
                if (this.isHorizontal) {
        ...
        _loadImage: function (_31, _32, _33) {
            ...
            dojo.connect(img, "onclick", this, function (evt) {
                dojo.publish(this.getClickTopicName(), [{
                    ...
                    largeUrl: this.imageStore.getValue(_31, this.imageLargeAttr),
                    title: this.imageStore.getValue(_31, this.titleAttr),
                    link: this.imageStore.getValue(_31, this.linkAttr)
                }]);
                return false;
            });
