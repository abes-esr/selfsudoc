...
if (!dojo._hasResource["dojox.image.SlideShow"]) {
    ...
    dojo.declare("dojox.image.SlideShow", [dijit._Widget, dijit._Templated], {
        ...
        setDataStore: function (_5, _6, _7) {
            ...
            var _8 = this;
            this._request = {
                query: {}, start: _6.start || 0, count: _6.count || this.pageSize, onBegin: function (_9, _a) {
                    _8.maxPhotos = _9;
                }
            };
            if (_6.query) {
        ...
        showImage: function (_17, _18) {
            ...
            if (_1a && _1a.length > 0) {
                dojo.fadeOut({
                    node: _1a[0], duration: 300, onEnd: function () {
        ...
        _showNav: function (_2f) {
            ...
            this._navAnim = dojo.fadeIn({
                node: this.navNode, duration: 300, onEnd: function () {
                    _33._navAnim = null;
                }
            });
            this._navAnim.play();
