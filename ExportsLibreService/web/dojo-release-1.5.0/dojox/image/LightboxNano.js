...
if (!dojo._hasResource["dojox.image.LightboxNano"]) {
    ...
    (function (d) {
        ...
        d.declare("dojox.image.LightboxNano", null, {
            href: "", duration: 500, preloadDelay: 5000, constructor: function (p, n) {
                var _6 = this;
                d.mixin(_6, p);
                ...
                if (!_a._loading) {
                    ...
                    var i = _a._img = d.create("img", {
                        ...
                        }, d.body()), ln = _a._loadingNode, n = d.query("img", _a._node)[0] || _a._node,
                        a = d.position(n, true), c = d.contentBox(n), b = d._getBorderExtents(n);
                    if (ln == null) {
                ...
                var _b = this, vp = _3(), w = _b._img.width, h = _b._img.height, _c = parseInt((vp.w - 20) * 0.9),
                    _d = parseInt((vp.h - 20) * 0.9), dd = d.doc, bg = _b._bg = d.create("div", {
                        style: {
                            backgroundColor: "#000",
                            opacity: 0,
                            position: _1,
                ...
                return d.animateProperty({
                    ...
                    properties: _10,
                    onEnd: _11 ? d.hitch(this, _11) : null
                });
            }, show: function (_12) {
                _12 = _12 || {};
