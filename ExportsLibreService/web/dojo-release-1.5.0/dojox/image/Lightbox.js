...
if (!dojo._hasResource["dojox.image.Lightbox"]) {
    ...
    dojo.declare("dojox.image.LightboxDialog", dijit.Dialog, {
        ...
        resizeTo: function (_8, _9) {
            ...
            var _c = dojox.fx.sizeTo({
                node: this.containerNode,
                duration: _8.duration || this.duration,
                width: _8.w + _a,
                height: _8.h + _b.h + _a
            });
        ...
        hide: function () {
            dojo.fadeOut({
                node: this.titleNode, duration: 200, onEnd: dojo.hitch(this, function () {
        ...
        _makeAnims: function () {
            ...
            this._loadingAnim = dojo.fx.combine([dojo.fadeOut({
                node: this.imgNode,
                duration: 175
