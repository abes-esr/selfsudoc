...
if (!dojo._hasResource["dojox.image.Badge"]) {
    ...
    dojo.declare("dojox.image.Badge", [dijit._Widget, dijit._Templated], {
        ...
        _enbiggen: function (e) {
            ...
            if (_8) {
                ...
                dojo.animateProperty({
                    node: _8.n,
                    properties: _a,
                    onEnd: dojo.hitch(this, "_loadUnder", _8, _a),
                    easing: this.easing
                }).play();
            }
        },
        _loadUnder: function (_c, _d) {
            ...
            var _10 = (_d.left >= 0);
            var _11 = (_d.top >= 0);
            var c = this.cols, e = _e + (_10 ? -1 : 1), f = _e + (_11 ? -c : c),
                g = (_11 ? (_10 ? e - c : f + 1) : (_10 ? f - 1 : e + c)), bc = this.baseClass;
        ...
        _disenbiggen: function (_12, _13) {
            ...
            dojo.animateProperty({
                node: _12.n,
                properties: dojo.mixin(_13, {width: _14, height: _14}),
                onEnd: dojo.hitch(this, "_cycle", _12, _13)
            }).play(5);
        },
