...
if (!dojo._hasResource["dojox.fx.split"]) {
    ...
    dojo.mixin(dojox.fx, {
        _split: function (_1) {
            ...
            var _7 = _4 != _5 ? dojo.position(_4, true) : {x: 0, y: 0}, _8 = dojo.position(_2, true),
                _9 = dojo.style(_2, "height"), _a = dojo.style(_2, "width"),
                _b = dojo.style(_2, "borderLeftWidth") + dojo.style(_2, "borderRightWidth"),
                _c = dojo.style(_2, "borderTopWidth") + dojo.style(_2, "borderBottomWidth"),
                _d = Math.ceil(_9 / _1.rows), _e = Math.ceil(_a / _1.columns), _f = dojo.create(_2.tagName, {
                    style: {
                        position: "absolute",
                        padding: 0,
                        margin: 0,
                        ...
                        width: _a + _b + "px",
                        background: "none",
                        overflow: _1.crop ? "hidden" : "visible",
                        zIndex: dojo.style(_2, "zIndex")
                    }
                }, _2, "after"), _10 = [], _11 = dojo.create(_2.tagName, {
                    style: {
                        position: "absolute",
                        border: "none",
                        padding: 0,
            ...
            _18.pieceAnimation = function (_1a, x, y, _1b) {
                var _1c = _1b.h / _18.rows, _1d = _1b.w / _18.columns, _1e = _18.distance * 2, _1f = _18.duration,
                    ps = _1a.style, _20 = parseInt(ps.top), _21 = parseInt(ps.left), _22 = 0, _23 = 0, _24 = 0;
                if (_18.random) {
                ...
                var _26 = ((_1b.h - _1c) / 2 - _1c * y), _27 = ((_1b.w - _1d) / 2 - _1d * x),
                    _28 = Math.sqrt(Math.pow(_27, 2) + Math.pow(_26, 2)), _29 = parseInt(_20 - _26 * _1e + _28 * _24),
                    _2a = parseInt(_21 - _27 * _1e + _28 * _23);
                var _2b = dojo.animateProperty({
                    node: _1a,
                    duration: _1f,
                    delay: _22,
                    easing: (_18.easing || (_18.unhide ? dojo.fx.easing.sinOut : dojo.fx.easing.circOut)),
                    beforeBegin: (_18.unhide ? function () {
                        if (_18.fade) {
                    ...
                    properties: {
                        top: (_18.unhide ? {start: _29, end: _20} : {start: _20, end: _29}),
                        left: (_18.unhide ? {start: _2a, end: _21} : {start: _21, end: _2a})
                    }
                });
                if (_18.fade) {
                    var _2c = dojo.animateProperty({
                        node: _1a,
                        duration: _1f,
                        delay: _22,
                        easing: (_18.fadeEasing || dojo.fx.easing.quadOut),
                        properties: {opacity: (_18.unhide ? {start: "0", end: "1"} : {start: "1", end: "0"})}
                    });
            ...
            _2f.pieceAnimation = function (_33, x, y, _34) {
                var _35 = Math.random() * (_2f.rows + _2f.columns) * _2f.interval, ps = _33.style,
                    _36 = (_2f.reverseOrder || _2f.distance < 0) ? ((x + y) * _2f.interval) : (((_2f.rows + _2f.columns) - (x + y)) * _2f.interval),
                    _37 = _35 * _31 + Math.max(1 - _31, 0) * _36, _38 = {};
                if (_2f.unhide) {
                ...
                var _39 = dojo.animateProperty({
                    ...
                    duration: _32,
                    delay: _37,
                    easing: (_2f.easing || (_2f.unhide ? dojo.fx.easing.sinIn : dojo.fx.easing.circIn)),
                    properties: _38,
                    beforeBegin: (_2f.unhide ? function () {
                        if (_2f.fade) {
            ...
            _3c.pieceAnimation = function (_40, x, y, _41) {
                var _42 = !(x % 2), _43 = !(y % 2), _44 = Math.random() * _3f,
                    _45 = (_3c.reverseOrder) ? (((_3c.rows + _3c.columns) - (x + y)) * _3c.interval) : ((x + y) * _3c.interval),
                    _46 = _44 * _3e + Math.max(1 - _3e, 0) * _45, _47 = {}, ps = _40.style;
                if (_3c.fade) {
                ...
                var _48 = parseInt(ps.left), top = parseInt(ps.top), _49 = _3c.distance * _41.w,
                    _4a = _3c.distance * _41.h;
                if (_3c.unhide) {
                    if (_42 == _43) {
                ...
                var _4b = dojo.animateProperty({
                    node: _40,
                    duration: _3f,
                    delay: _46,
                    easing: (_3c.easing || dojo.fx.easing.sinInOut),
                    properties: _47,
                    beforeBegin: (_3c.unhide ? function () {
                        if (_3c.fade) {
                            ps.opacity = "0";
                        }
                        if (_42 == _43) {
            ...
            _4e.pieceAnimation = function (_51, x, y, _52) {
                var _53 = _52.h / _4e.rows, _54 = _52.w / _4e.columns, _55 = !(x % 2), _56 = !(y % 2),
                    _57 = Math.random() * _50,
                    _58 = (_4e.interval < 0) ? (((_4e.rows + _4e.columns) - (x + y)) * _4e.interval * -1) : ((x + y) * _4e.interval),
                    _59 = _57 * _4e.random + Math.max(1 - _4e.random, 0) * _58, _5a = {}, ps = _51.style;
                if (_4e.fade) {
                ...
                if (_55) {
                    if (_56) {
                        _5a.top = _4e.unhide ? {start: top + _53 * _4e.distance, end: top} : {
                            start: top,
                            end: top + _53 * _4e.distance
                        };
                    } else {
                        _5a.left = _4e.unhide ? {start: _5b + _54 * _4e.distance, end: _5b} : {
                            start: _5b,
                            end: _5b + _54 * _4e.distance
                        };
                    }
                }
                if (_55 != _56) {
                    _5a.width = _4e.unhide ? {start: _54 * (1 - _4e.distance), end: _54} : {
                        start: _54,
                        end: _54 * (1 - _4e.distance)
                    };
                } else {
                    _5a.height = _4e.unhide ? {start: _53 * (1 - _4e.distance), end: _53} : {
                        start: _53,
                        end: _53 * (1 - _4e.distance)
                    };
                }
                var _5c = dojo.animateProperty({
                    ...
                    duration: _50,
                    delay: _59,
                    easing: (_4e.easing || dojo.fx.easing.sinInOut),
                    properties: _5a,
                    beforeBegin: (_4e.unhide ? function () {
                        if (_4e.fade) {
            ...
            _5f.pieceAnimation = function (_63, x, y, _64) {
                var _65 = Math.random() * _5f.duration,
                    _66 = (_5f.reverseOrder) ? (((_5f.rows + _5f.columns) - (x + y)) * Math.abs(_5f.interval)) : ((x + y) * _5f.interval),
                    _67 = _65 * _61 + Math.max(1 - _61, 0) * _66, _68 = dojo.animateProperty({
                        node: _63,
                        duration: _62,
                        delay: _67,
                        easing: (_5f.easing || dojo.fx.easing.sinInOut),
                        properties: {opacity: (_5f.unhide ? {start: "0", end: "1"} : {start: "1", end: "0"})},
                        beforeBegin: (_5f.unhide ? function () {
