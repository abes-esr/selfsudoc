...
if (!dojo._hasResource["dojox.fx._base"]) {
    ...
    dojox.fx.sizeTo = function (_1) {
        ...
        var _e = dojo.animateProperty(dojo.mixin({
            properties: {
                height: function () {
                    _b();
        ...
        var _f = dojo.animateProperty(dojo.mixin({
            properties: {
                width: function () {
    ...
    dojox.fx.slideBy = function (_11) {
        ...
        _14();
        var _15 = dojo.animateProperty(dojo.mixin({
            properties: {
                top: top + (_11.top || 0),
                left: _13 + (_11.left || 0)
            }
    ...
    dojox.fx.crossFade = function (_16) {
        var _17 = _16.nodes[0] = dojo.byId(_16.nodes[0]), op1 = dojo.style(_17, "opacity"),
            _18 = _16.nodes[1] = dojo.byId(_16.nodes[1]), op2 = dojo.style(_18, "opacity");
