...
if (!dojo._hasResource["dojox.fx.text"]) {
    ...
    dojox.fx.text._split = function (_1) {
        ...
        var _4 = (_1.text && typeof (_1.text) == "string") ? _1.text : _2.innerHTML, _5 = s.height, _6 = s.width,
            _7 = [];
        ...
        function _f(_10) {
            ...
            if (_10.tagName == "SPAN" && _10.childNodes.length == 1 && _10.firstChild.nodeType == 3) {
                ...
                dojo.style(_10, {
                    padding: 0,
                    margin: 0,
                    top: (_1.crop ? "0px" : _12.t + "px"),
                    left: (_1.crop ? "0px" : _12.l + "px"),
                    display: "inline"
                });
    ...
    dojox.fx.text.explode = function (_15) {
        ...
        _15.pieceAnimation = function (_17, _18, _19, _1a, _1b) {
            ...
            var _2b = dojo.animateProperty({
                ...
                duration: _1f,
                delay: _22,
                easing: (_15.easing || (_15.unhide ? dojo.fx.easing.sinOut : dojo.fx.easing.circOut)),
                beforeBegin: (_15.unhide ? function () {
                    if (_15.fade) {
                ...
                properties: {
                    top: (_15.unhide ? {start: _29, end: _20} : {start: _20, end: _29}),
                    left: (_15.unhide ? {start: _2a, end: _21} : {start: _21, end: _2a})
                }
            });
            if (_15.fade) {
                var _2c = dojo.animateProperty({
                    ...
                    duration: _1f,
                    delay: _22,
                    easing: (_15.fadeEasing || dojo.fx.easing.quadOut),
                    properties: {opacity: (_15.unhide ? {start: 0, end: 1} : {end: 0})}
                });
    ...
    dojox.fx.text.blockFadeOut = function (_42) {
        ...
        _42.pieceAnimation = function (_45, _46, _47, _48, _49) {
            ...
            var _4f = dojo.animateProperty({
                node: _45,
                duration: _4b,
                delay: _4e,
                easing: (_42.easing || dojo.fx.easing.sinInOut),
                properties: {opacity: (_42.unhide ? {start: 0, end: 1} : {end: 0})},
                beforeBegin: (_42.unhide ? function () {
    ...
    dojox.fx.text.backspace = function (_52) {
        ...
        _52.pieceAnimation = function (_56, _57, _58, _59, _5a) {
            var _5b = _52.interval || (_52.duration / (1.5 * _5a)),
                _5c = ("textContent" in _56) ? _56.textContent : _56.innerText, _5d = _5c.match(/\s/g);
            ...
            var _60 = dojo.animateProperty({
                ...
                duration: 1,
                delay: _55,
                easing: (_52.easing || dojo.fx.easing.sinInOut),
                properties: {opacity: (_52.unhide ? {start: 0, end: 1} : {end: 0})},
                beforeBegin: _5e,
                onEnd: _5f
            });
            if (_52.unhide) {
