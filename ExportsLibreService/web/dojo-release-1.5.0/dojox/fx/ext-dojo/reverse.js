...
if (!dojo._hasResource["dojox.fx.ext-dojo.reverse"]) {
    ...
    dojo.extend(dojo.Animation, {
        _reversed: false, reverse: function (_1, _2) {
            var _3 = this.status() == "playing";
            this.pause();
            this._reversed = !this._reversed;
            var d = this.duration, _4 = d * this._percent, _5 = d - _4, _6 = new Date().valueOf(),
                cp = this.curve._properties, p = this.properties, nm;
            this._endTime = _6 + _4;
