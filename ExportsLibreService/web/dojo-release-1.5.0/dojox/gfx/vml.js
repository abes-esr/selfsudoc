...
if (!dojo._hasResource["dojox.gfx.vml"]) {
    ...
    (function () {
        ...
        d.extend(g.Shape, {
            setFill: function (_3) {
                ...
                if (typeof _3 == "object" && "type" in _3) {
                    switch (_3.type) {
                        case "linear":
                            var _4 = this._getRealMatrix(), _5 = this.getBoundingBox(),
                                _6 = this._getRealBBox ? this._getRealBBox() : this.getTransformedBoundingBox();
                            s = [];
                            if (this.fillStyle !== _3) {
                                this.fillStyle = g.makeParameters(g.defaultLinearGradient, _3);
                            }
                            f = g.gradient.project(_4, this.fillStyle, {x: _5.x, y: _5.y}, {
                                x: _5.x + _5.width,
                                y: _5.y + _5.height
                            }, _6[0], _6[2]);
                            a = f.colors;
                        ...
                        case "radial":
                            ...
                            this.fillStyle = f;
                            var l = parseFloat(this.rawNode.style.left), t = parseFloat(this.rawNode.style.top),
                                w = parseFloat(this.rawNode.style.width), h = parseFloat(this.rawNode.style.height),
                                c = isNaN(w) ? 1 : 2 * f.r / w;
                            a = [];
                ...
                if (_a) {
                    ...
                    if (_b) {
                        _b.on = "f";
                        var mt = _a.xx.toFixed(8) + " " + _a.xy.toFixed(8) + " " + _a.yx.toFixed(8) + " " + _a.yy.toFixed(8) + " 0 0",
                            _c = Math.floor(_a.dx).toFixed() + "px " + Math.floor(_a.dy).toFixed() + "px",
                            s = this.rawNode.style, l = parseFloat(s.left), t = parseFloat(s.top),
        ...
        dojo.declare("dojox.gfx.Path", g.path.Path, {
            ...
            _addArgs: function (_3a, _3b, _3c, _3d) {
            ...
            _adjustRelCrd: function (_3e, _3f, _40) {
                var n = _3f instanceof Array ? _3f : _3f.args, l = n.length, _41 = new Array(l), i = 0, x = _3e.x,
                    y = _3e.y;
                if (typeof x != "number") {
                    _41[0] = x = n[0];
                    _41[1] = y = n[1];
        ...
        dojo.declare("dojox.gfx.Surface", gs.Surface, {
            constructor: function () {
                ...
                var t = this.rawNode ? {
                    ...
                    height: g.normalizedLength(this.rawNode.style.height)
                } : null;
                if (t.width <= 0) {
                    t.width = this.width;
                }
        ...
        g.createSurface = function (_6a, _6b, _6c) {
            ...
            var s = new g.Surface(), p = d.byId(_6a), c = s.clipNode = p.ownerDocument.createElement("div"),
                r = s.rawNode = p.ownerDocument.createElement("v:group"), cs = c.style, rs = r.style;
            if (d.isIE > 7) {
