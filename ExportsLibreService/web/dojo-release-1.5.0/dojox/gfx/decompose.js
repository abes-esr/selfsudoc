...
if (!dojo._hasResource["dojox.gfx.decompose"]) {
    ...
    (function () {
        ...
        var _6 = function (_7) {
            var M = m.normalize(_7), b = -M.xx - M.yy, c = M.xx * M.yy - M.xy * M.yx, d = Math.sqrt(b * b - 4 * c),
                l1 = -(b + (b < 0 ? -d : d)) / 2, l2 = c / l1, _8 = M.xy / (l1 - M.xx), _9 = 1, _a = M.xy / (l2 - M.xx),
                _b = 1;
            if (eq(l1, l2)) {
                _8 = 1, _9 = 0, _a = 0, _b = 1;
            }
        ...
        var _c = function (M, _d) {
            var _e = _4(M), a = _d.angle1 = (Math.atan2(M.yx, M.yy) + Math.atan2(-_e * M.xy, _e * M.xx)) / 2,
                _f = Math.cos(a), sin = Math.sin(a);
            _d.sx = _1(M.xx / _f, _f, -M.xy / sin, sin);
            _d.sy = _1(M.yy / _f, _f, M.yx / sin, sin);
            return _d;
        };
        var _10 = function (M, _11) {
            var _12 = _4(M), a = _11.angle2 = (Math.atan2(_12 * M.yx, _12 * M.xx) + Math.atan2(-M.xy, M.yy)) / 2,
        ...
        dojox.gfx.decompose = function (_13) {
            ...
            var MT = _2(M), u = _6([M, MT]), v = _6([MT, M]),
