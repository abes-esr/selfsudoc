    ...
    (function () {
        ...
        dojox.gfx.gradutils.getColor = function (_5, pt) {
            ...
            if (_5) {
                switch (_5.type) {
                    case "linear":
                        var _6 = Math.atan2(_5.y2 - _5.y1, _5.x2 - _5.x1), _7 = m.rotate(-_6),
                            _8 = m.project(_5.x2 - _5.x1, _5.y2 - _5.y1), p = m.multiplyPoint(_8, pt),
                            _9 = m.multiplyPoint(_8, _5.x1, _5.y1), _a = m.multiplyPoint(_8, _5.x2, _5.y2),
                            _b = m.multiplyPoint(_7, _a.x - _9.x, _a.y - _9.y).x,
