    ...
    dojo.declare("dojox.gfx.shape.Line", dojox.gfx.Shape, {
        constructor: function (_1f) {
            ...
            if (!this.bbox) {
                var _20 = this.shape;
                this.bbox = {
                    x: Math.min(_20.x1, _20.x2),
                    y: Math.min(_20.y1, _20.y2),
                    width: Math.abs(_20.x2 - _20.x1),
                    height: Math.abs(_20.y2 - _20.y1)
                };
            }
            return this.bbox;
        }
