    ...
    (function () {
        ...
        d.extend(g.Shape, {
            setFill: function (_8) {
                ...
                var _f = _1.xmlns.svg;
                this.fillStyle = f;
                var _10 = this._getParentSurface(), _11 = _10.defNode, _12 = this.rawNode.getAttribute("fill"),
                    ref = _1.getRef(_12);
                if (ref) {
                    _12 = ref;
        ...
        dojo.declare("dojox.gfx.Path", g.path.Path, {
            _updateWithSegment: function (_23) {
        ...
        dojo.declare("dojox.gfx.TextPath", g.path.TextPath, {
            _updateWithSegment: function (_25) {
                g.Path.superclass._updateWithSegment.apply(this, arguments);
                this._setTextPath();
