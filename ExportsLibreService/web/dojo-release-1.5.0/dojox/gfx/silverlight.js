...
if (!dojo._hasResource["dojox.gfx.silverlight"]) {
    ...
    dojo.extend(dojox.gfx.Shape, {
        setFill: function (_2) {
            ...
            if (typeof (_2) == "object" && "type" in _2) {
                switch (_2.type) {
                    ...
                    case "radial":
                        ...
                        var _4 = p.createFromXaml("<RadialGradientBrush/>"),
                            c = dojox.gfx.matrix.multiplyPoint(dojox.gfx.matrix.invert(this._getAdjustedMatrix()), f.cx, f.cy),
                            pt = c.x + "," + c.y;
            ...
            if (tm) {
                var p = this.rawNode.getHost().content, m = p.createFromXaml("<MatrixTransform/>"),
    ...
    dojo.declare("dojox.gfx.Path", dojox.gfx.path.Path, {
        _updateWithSegment: function (_15) {
    ...
    dojo.declare("dojox.gfx.TextPath", dojox.gfx.path.TextPath, {
        _updateWithSegment: function (_17) {
    ...
    dojox.gfx.silverlight.Font = {
        _setFont: function () {
            var f = this.fontStyle, r = this.rawNode, fw = dojox.gfx.silverlight.fontweight,
    ...
    (function () {
        ...
        var _2c = function (s, a) {
            var ev = {
                target: s, currentTarget: s, preventDefault: function () {
        ...
        var _2f = {
            onclick: {name: "MouseLeftButtonUp", fix: _2c},
            onmouseenter: {name: "MouseEnter", fix: _2c},
            onmouseleave: {name: "MouseLeave", fix: _2c},
            onmouseover: {name: "MouseEnter", fix: _2c},
            onmouseout: {name: "MouseLeave", fix: _2c},
            onmousedown: {name: "MouseLeftButtonDown", fix: _2c},
            onmouseup: {name: "MouseLeftButtonUp", fix: _2c},
            onmousemove: {name: "MouseMove", fix: _2c},
            onkeydown: {name: "KeyDown", fix: _2e},
            onkeyup: {name: "KeyUp", fix: _2e}
        };
        var _30 = {
            connect: function (_31, _32, _33) {
                var _34, n = _31 in _2f ? _2f[_31] : {
                    name: _31, fix: function () {
                        return {};
                    }
                };
