...
if (!dojo._hasResource["dojox.widget.Rotator"]) {
    ...
    (function (d) {
        ...
        d.declare("dojox.widget.Rotator", null, {
            transition: _1, transitionParams: "duration:" + _2, panes: null, constructor: function (_6, _7) {
                d.mixin(this, _6);
                var _8 = this, t = _8.transition, tt = _8._transitions = {}, _9 = _8._idMap = {},
                    tp = _8.transitionParams = eval("({ " + _8.transitionParams + " })"),
                    _7 = _8._domNode = dojo.byId(_7), cb = _8._domNodeContentBox = d.contentBox(_7),
                    p = {left: 0, top: 0}, _a = function (bt, dt) {
                ...
                d.query(">", _7).forEach(function (n, i) {
                    var q = {
                        node: n,
                        idx: i,
                        params: d.mixin({}, tp, eval("({ " + (d.attr(n, "transitionParams") || "") + " })"))
                    }, r = q.trans = d.attr(n, "transition") || _8.transition;
                ...
                var _10 = {current: _e, next: _f, rotator: _b},
                    _11 = _b.anim = _b._transitions[_f.trans](d.mixin({rotatorBox: _b._domNodeContentBox}, _10, _f.params));
                if (_11) {
