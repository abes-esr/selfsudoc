...
if (!dojo._hasResource["dojox.widget.Standby"]) {
    ...
    dojo.declare("dojox.widget.Standby", [dijit._Widget, dijit._Templated], {
        templateString: "<div>" + "<div style=\"display: none; opacity: 0; z-index: 9999; " + "position: absolute; cursor:wait;\" dojoAttachPoint=\"_underlayNode\"></div>" + "<img src=\"${image}\" style=\"opacity: 0; display: none; z-index: -10000; " + "position: absolute; top: 0px; left: 0px; cursor:wait;\" " + "dojoAttachPoint=\"_imageNode\">" + "<div style=\"opacity: 0; display: none; z-index: -10000; position: absolute; " + "top: 0px;\" dojoAttachPoint=\"_textNode\"></div>" + "</div>",
        _underlayNode: null,
        _imageNode: null,
        _textNode: null,
        _centerNode: null,
        ...
        _fadeIn: function () {
            var _22 = this;
            var _23 = dojo.animateProperty({
                duration: _22.duration,
                node: _22._underlayNode,
                properties: {opacity: {start: 0, end: 0.75}}
            });
            var _24 = dojo.animateProperty({
                duration: _22.duration,
                node: _22._centerNode,
        ...
        _fadeOut: function () {
            var _26 = this;
            var _27 = dojo.animateProperty({
                duration: _26.duration,
                node: _26._underlayNode,
                properties: {opacity: {start: 0.75, end: 0}},
                onEnd: function () {
                    dojo.style(this.node, {"display": "none", "zIndex": "-1000"});
                }
            });
            var _28 = dojo.animateProperty({
                duration: _26.duration,
                node: _26._centerNode,
