...
if (!dojo._hasResource["dojox.widget.FeedPortlet"]) {
    ...
    dojo.declare("dojox.widget.FeedPortlet", dojox.widget.Portlet, {
        local: false, maxResults: 5, url: "", openNew: true, showFeedTitle: true, postCreate: function () {
            ...
            var _9 = {
                query: _8, count: this.maxResults, onComplete: dojo.hitch(this, function (_a) {
    ...
    dojo.declare("dojox.widget.ExpandableFeedPortlet", dojox.widget.FeedPortlet, {
        onlyOpenOne: false, generateResults: function (_13) {
            var _14 = this.store;
            ...
            dojo.forEach(_13, dojo.hitch(this, dojo.hitch(this, function (_19) {
                ...
                var _1b = dojo.create("div", {
                    ...
                    innerHTML: this._getContent(_19)
                }, li);
                dojo.create("span", {
                    "class": _15,
                    innerHTML: "<img src='" + dojo.config.baseUrl + "/resources/blank.gif'>"
                }, _1a);
    ...
    dojo.declare("dojox.widget.PortletFeedSettings", dojox.widget.PortletSettings, {
        "class": "dojoxPortletFeedSettings", urls: null, selectedIndex: 0, buildRendering: function () {
            ...
            this.addChild(new dijit.form.Button({
                label: "Load", onClick: dojo.hitch(this, function () {
