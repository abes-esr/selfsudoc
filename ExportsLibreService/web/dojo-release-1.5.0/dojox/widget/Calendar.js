...
if (!dojo._hasResource["dojox.widget.Calendar"]) {
    ...
    dojo.declare("dojox.widget._CalendarBase", [dijit._Widget, dijit._Templated, dijit._Container], {
        ...
        postCreate: function () {
            ...
            var _6 = new Date();
            this.footer.innerHTML = "Today: " + dojo.date.locale.format(_6, {
        ...
        _transitionVert: function (_1a) {
            ...
            var _20 = dojo.animateProperty({
                node: _1b.domNode, properties: {top: _1e}, onEnd: function () {
                    dojo.style(_1b.domNode, "visibility", "hidden");
                }
            });
            var _21 = dojo.animateProperty({
                node: _1c.domNode, properties: {top: _1f}, onEnd: function () {
                    _1c.onDisplay();
                }
            });
        ...
        _slideTable: function (_22, _23, _24) {
            ...
            var _28 = dojo.animateProperty({
                node: _26, properties: {left: _27 * _23 * -1}, duration: 500, onEnd: function () {
    ...
    dojo.declare("dojox.widget._CalendarView", dijit._Widget, {
        headerClass: "", useHeader: true, cloneClass: function (_32, n, _33) {
    ...
    dojo.declare("dojox.widget._CalendarDay", null, {
        parent: null, constructor: function () {
