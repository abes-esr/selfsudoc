    ...
    (function (d) {
        ...
        dojo.declare("dojox.widget.ColorPicker", dijit.form._FormWidget, {
            ...
            _updateColor: function () {
                var _12 = this.PICKER_HUE_SELECTOR_H / 2, _13 = this.PICKER_SAT_SELECTOR_H / 2,
                    _14 = this.PICKER_SAT_SELECTOR_W / 2;
                var _15 = d.style(this.hueCursorNode, "top") + _12, _16 = d.style(this.cursorNode, "top") + _13,
                    _17 = d.style(this.cursorNode, "left") + _14, h = Math.round(360 - (_15 / this.PICKER_HUE_H * 360)),
                    col = dojox.color.fromHsv(h, _17 / this.PICKER_SAT_VAL_W * 100, 100 - (_16 / this.PICKER_SAT_VAL_H * 100));
            ...
            _updatePickerLocations: function (col) {
                var _1a = this.PICKER_HUE_SELECTOR_H / 2, _1b = this.PICKER_SAT_SELECTOR_H / 2,
                    _1c = this.PICKER_SAT_SELECTOR_W / 2;
                var hsv = col.toHsv(), _1d = Math.round(this.PICKER_HUE_H - hsv.h / 360 * this.PICKER_HUE_H) - _1a,
                    _1e = Math.round(hsv.s / 100 * this.PICKER_SAT_VAL_W) - _1c,
                    _1f = Math.round(this.PICKER_SAT_VAL_H - hsv.v / 100 * this.PICKER_SAT_VAL_H) - _1b;
