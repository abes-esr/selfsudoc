...
if (!dojo._hasResource["dojox.widget.Dialog"]) {
    ...
    dojo.declare("dojox.widget.Dialog", [dojox.layout.ContentPane, dijit._DialogBase], {
        ...
        _setSize: function () {
            ...
            return this._displaysize = {
                w: _3 ? tc.scrollWidth : this.dimensions[0],
                h: _3 ? tc.scrollHeight : this.dimensions[1]
            };
        },
        show: function () {
            if (this.open) {
        ...
        _handleNav: function (e) {
            var _4 = "_navOut", _5 = "_navIn", _6 = (e.type == "mouseout" ? _5 : _4),
                _7 = (e.type == "mouseout" ? _4 : _5);
            this[_6].stop();
            this[_7].play();
        },
        _position: function () {
