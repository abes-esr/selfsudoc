...
if (!dojo._hasResource["dojox.widget.rotator.Pan"]) {
    ...
    (function (d) {
        ...
        function _4(_5, _6) {
            var n = _6.next.node, r = _6.rotatorBox, m = _5 % 2, a = m ? "left" : "top",
                s = (m ? r.w : r.h) * (_5 < 2 ? -1 : 1), p = {}, q = {};
            d.style(n, "display", "");
            p[a] = {start: 0, end: -s};
            q[a] = {start: s, end: 0};
            return d.fx.combine([d.animateProperty({
                node: _6.current.node,
                duration: _6.duration,
                properties: p,
                easing: _6.easing
            }), d.animateProperty({node: n, duration: _6.duration, properties: q, easing: _6.easing})]);
        };
        ...
        d.mixin(dojox.widget.rotator, {
            pan: function (_8) {
                var w = _8.wrap, p = _8.rotator.panes, _9 = p.length, z = _9, j = _8.current.idx, k = _8.next.idx,
                    nw = Math.abs(k - j), ww = Math.abs((_9 - Math.max(j, k)) + Math.min(j, k)) % _9, _a = j < k,
                    _b = _3, _c = [], _d = [], _e = _8.duration;
