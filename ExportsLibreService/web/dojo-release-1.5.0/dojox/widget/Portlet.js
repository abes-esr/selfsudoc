...
if (!dojo._hasResource["dojox.widget.Portlet"]) {
    ...
    dojo.declare("dojox.widget.PortletSettings", [dijit._Container, dijit.layout.ContentPane], {
        ...
        toggle: function () {
            ...
            if (dojo.style(n, "display") == "none") {
                ...
                dojo.fx.wipeOut({
                    node: n, onEnd: dojo.hitch(this, function () {
    ...
    dojo.declare("dojox.widget.PortletDialogSettings", dojox.widget.PortletSettings, {
        dimensions: null, constructor: function (_17, _18) {
