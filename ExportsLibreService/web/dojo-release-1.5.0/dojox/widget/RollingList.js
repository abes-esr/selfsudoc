...
if (!dojo._hasResource["dojox.widget.RollingList"]) {
    ...
    dojo.declare("dojox.widget._RollingListPane", [dijit.layout.ContentPane, dijit._Templated, dijit._Contained], {
        ...
        _focusByNode: true,
        minWidth: 0,
        _setContentAndScroll: function (_1, _2) {
        ...
        _doQuery: function () {
            ...
            if (this.items && _e) {
                ...
                if (this.items) {
                    ...
                    this.store.fetch({
                        query: this.query, onComplete: function (_f) {
                            this.items = _f;
                            this.onItems();
                        }, onError: function (e) {
    ...
    dojo.declare("dojox.widget._RollingListGroupPane", [dojox.widget._RollingListPane], {
        ...
        _getMenu: function () {
            var _2a = this;
            var _2b = new dijit.Menu({
                parentMenu: this.parentPane ? this.parentPane._menu : null, onCancel: function (_2c) {
                    if (_2a.parentPane) {
            ...
            var _57 = dojo.hitch(this, function (_58, _59) {
                ...
                if (this.parentAttr && _5a.getFeatures()["dojo.data.api.Identity"] && ((id = this.store.getValue(_58, this.parentAttr)) || id === "")) {
                    ...
                    dojo.forEach(this.childrenAttrs, function (_5d) {
                        ...
                        q[_5d] = _58;
                        _5a.fetch({
                            query: q, scope: this, onComplete: function (_5e) {
            ...
            var _5f = dojo.hitch(this, function (_60, idx) {
                ...
                if (set && _61) {
                    var fx = dojo.hitch(this, function () {
                        ...
                        if (_63) {
                            idx++;
                            _61._menu.onItemClick(_63, {
                                type: "internal", stopPropagation: function () {
        ...
        _getMenuItemForItem: function (_70, _71) {
            ...
            if (!_70 || !_72 || !_72.isItem(_70)) {
                var i = new dijit.MenuItem({
                    label: "---", disabled: true, iconClass: "dojoxEmpty", focus: function () {
                    }
                });
