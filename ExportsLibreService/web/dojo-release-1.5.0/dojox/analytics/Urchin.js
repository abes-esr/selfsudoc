...
if (!dojo._hasResource["dojox.analytics.Urchin"]) {
    ...
    dojo.declare("dojox.analytics.Urchin", null, {
        acct: "", constructor: function (_1) {
            this.tracker = null;
            dojo.mixin(this, _1);
            this.acct = this.acct || dojo.config.urchin;
            var re = /loaded|complete/, _2 = ("https:" == dojo.doc.location.protocol) ? "https://ssl." : "http://www.",
                h = dojo.doc.getElementsByTagName("head")[0],
                n = dojo.create("script", {src: _2 + "google-analytics.com/ga.js"}, h);
