...
if (!dojo._hasResource["dojox.rpc.Rest"]) {
    ...
    (function () {
        ...
        _7 = dojox.rpc.Rest = function (_d, _e, _f, _10) {
            ...
            _11._schema = _f;
            _11.cache = {
                serialize: _e ? ((dojox.json && dojox.json.ref) || dojo).toJson : function (_13) {
                    return _13;
                }
            };
            _11._getRequest = _10 || function (id, _14) {
                ...
                var _16 = {
                    url: _d + (id == null ? "" : id),
                    handleAs: _e ? "json" : "text",
                    contentType: _e ? "application/json" : "text/plain",
                    sync: dojox.rpc._sync,
                    headers: {Accept: _e ? "application/json,application/javascript" : "*/*"}
                };
