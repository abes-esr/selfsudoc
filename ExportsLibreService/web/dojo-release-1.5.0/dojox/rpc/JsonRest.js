...
if (!dojo._hasResource["dojox.rpc.JsonRest"]) {
    ...
    (function () {
        ...
        function _3(_4, _5, _6, _7) {
            ...
            _6 = _6 && dojox.json.ref.resolveJson(_6, {
                defaultId: _7,
                index: _2._index,
                timeStamps: _8 && _2._timeStamps,
                time: _8,
                idPrefix: _4.servicePath.replace(/[^\/]*$/, ""),
                idAttribute: jr.getIdAttribute(_4),
                schemas: jr.schemas,
                loader: jr._loader,
                idAsRef: _4.idAsRef,
        ...
        jr = dojox.rpc.JsonRest = {
            serviceClass: dojox.rpc.Rest, conflictDateHeader: "If-Unmodified-Since", commit: function (_a) {
                _a = _a || {};
                var _b = [];
                var _c = {};
                var _d = [];
