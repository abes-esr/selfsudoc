...
if (!dojo._hasResource["dojox.mobile.app.ImageThumbView"]) {
    ...
    dojo.declare("dojox.mobile.app.ImageThumbView", dijit._Widget, {
        items: null,
        urlParam: "url",
        itemTemplate: "<div class=\"mblThumbInner\">" + "<div class=\"mblThumbOverlay\"></div>" + "<div class=\"mblThumbMask\">" + "<div class=\"mblThumbSrc\" style=\"background-image:url(${url})\"></div>" + "</div>" + "</div>",
        minPadding: 5,
        maxPerRow: 3,
        ...
        addThumb: function (_14, url, _15) {
            ...
            if (this.cache.length > 0) {
                ...
                _16 = dojo.create("div", {
                    ...
                    innerHTML: dojo.string.substitute(this.itemTemplate, {url: url}, null, this)
                }, this.domNode);
            }
