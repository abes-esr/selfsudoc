...
if (!dojo._hasResource["dojox.mobile.app.ListSelector"]) {
    ...
    dojo.declare("dojox.mobile.app.ListSelector", dojox.mobile.app._Widget, {
        data: null, controller: null, onChoose: null, destroyOnHide: false, _setDataAttr: function (_1) {
            this.data = _1;
            if (this.data) {
                this.render();
            }
            ...
            var _11 = dojo.animateProperty({
                node: this.domNode,
                duration: 400,
                properties: {
                    width: {start: 1, end: _c},
                    height: {start: 1, end: _e},
                    top: {start: _9.y, end: _10},
                    left: {start: _9.x, end: (_a.w / 2 - _c / 2)},
            ...
            var _13 = this;
            var _14 = dojo.animateProperty({
                node: this.domNode,
                duration: 500,
                properties: {width: {end: 1}, height: {end: 1}, opacity: {end: 0}, fontSize: {end: 1}},
                onEnd: function () {
