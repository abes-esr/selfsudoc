    ...
    dojo.extend(dojox.mobile.app.List, {
        deleteRow: function () {
            ...
            dojo.animateProperty({
                node: _9,
                duration: 800,
                properties: {height: {start: _a, end: 1}, paddingTop: {end: 0}, paddingBottom: {end: 0}},
