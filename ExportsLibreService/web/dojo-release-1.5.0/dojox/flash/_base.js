...
if (!dojo._hasResource["dojox.flash._base"]) {
    ...
    dojox.flash.Info.prototype = {
        ...
        capable: false,
        installing: false,
        isVersionOrAbove: function (_6, _7, _8) {
            _8 = parseFloat("." + _8);
    ...
    dojox.flash.Embed.prototype = {
        width: 215, height: 138, id: "flashObject", _visible: true, protocol: function () {
    ...
    dojox.flash.Communicator.prototype = {
        _addExternalInterfaceCallback: function (_2c) {
