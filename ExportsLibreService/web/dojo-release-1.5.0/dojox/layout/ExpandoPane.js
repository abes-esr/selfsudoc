...
if (!dojo._hasResource["dojox.layout.ExpandoPane"]) {
    ...
    dojo.declare("dojox.layout.ExpandoPane", [dijit.layout.ContentPane, dijit._Templated, dijit._Contained, dijit._Container], {
        ...
        _setupAnims: function () {
            ...
            var _5 = {node: this.domNode, duration: this.duration}, _6 = this._isHorizontal, _7 = {}, _8 = {},
                _9 = _6 ? "height" : "width";
        ...
        resize: function (_a, _b) {
            ...
            this._contentBox = {
                w: _a && "w" in _a ? _a.w : _b.w,
                h: (_a && "h" in _a ? _a.h : _b.h) - this._titleHeight
            };
