...
if (!dojo._hasResource["dojox.layout.GridContainer"]) {
    ...
    dojo.declare("dojox.layout.GridContainer", dojox.layout.GridContainerLite, {
        ...
        _addColumn: function (_27) {
            var _28 = this._grid, _29, _2a, _2b, _2c, _2d = (this.mode == "right"), _2e = this.acceptTypes.join(","),
                m = this._dragManager;
