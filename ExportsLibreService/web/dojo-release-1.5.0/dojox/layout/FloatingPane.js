...
if (!dojo._hasResource["dojox.layout.FloatingPane"]) {
    ...
    dojo.declare("dojox.layout.FloatingPane", [dojox.layout.ContentPane, dijit._Templated], {
        closable: true,
        dockable: true,
        resizable: false,
        maxable: false,
        ...
        hide: function (_5) {
            dojo.fadeOut({
                node: this.domNode, duration: this.duration, onEnd: dojo.hitch(this, function () {
        ...
        show: function (_6) {
            var _7 = dojo.fadeIn({
                node: this.domNode, duration: this.duration, beforeBegin: dojo.hitch(this, function () {
    ...
    dojo.declare("dojox.layout.Dock", [dijit._Widget, dijit._Templated], {
        ...
        autoPosition: false,
        addNode: function (_c) {
            var _d = dojo.create("li", null, this.containerNode),
                _e = new dojox.layout._DockNode({title: _c.title, paneRef: _c}, _d);
            _e.startup();
            return _e;
        },
        startup: function () {
