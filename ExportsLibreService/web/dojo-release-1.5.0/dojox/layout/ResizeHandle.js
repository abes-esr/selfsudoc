...
if (!dojo._hasResource["dojox.layout.ResizeHandle"]) {
    ...
    dojo.declare("dojox.layout.ResizeHandle", [dijit._Widget, dijit._Templated], {
        ...
        _getNewCoords: function (e) {
            ...
            var dx = (this.isLeftToRight() ? this.startPoint.x - e.clientX : e.clientX - this.startPoint.x),
                dy = this.startPoint.y - e.clientY, _5 = this.startSize.w - (this._resizeX ? dx : 0),
                _6 = this.startSize.h - (this._resizeY ? dy : 0);
        ...
        _changeSizing: function (e) {
            ...
            if (this.targetWidget && dojo.isFunction(this.targetWidget.resize)) {
                ...
                if (this.animateSizing) {
                    var _a = dojo.fx[this.animateMethod]([dojo.animateProperty({
                        node: this.targetDomNode,
                        properties: {width: {start: this.startSize.w, end: _9.w}},
                        duration: this.animateDuration
                    }), dojo.animateProperty({
                        node: this.targetDomNode,
                        properties: {height: {start: this.startSize.h, end: _9.h}},
                        duration: this.animateDuration
                    })]);
                    _a.play();
                } else {
    ...
    dojo.declare("dojox.layout._ResizeHelper", dijit._Widget, {
        show: function () {
            dojo.fadeIn({
                node: this.domNode, duration: 120, beforeBegin: function (n) {
                    dojo.style(n, "display", "");
                }
            }).play();
        }, hide: function () {
            dojo.fadeOut({
                node: this.domNode, duration: 250, onEnd: function (n) {
