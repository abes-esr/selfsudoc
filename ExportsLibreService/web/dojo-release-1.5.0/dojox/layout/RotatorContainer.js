...
if (!dojo._hasResource["dojox.layout.RotatorContainer"]) {
    ...
    dojo.declare("dojox.layout.RotatorContainer", [dijit.layout.StackContainer, dijit._Templated], {
        ...
        _cycle: function (_3) {
            ...
            var c = this.getChildren(), _4 = c.length,
                i = dojo.indexOf(c, this.selectedChildWidget) + (_3 === false || (_3 !== true && this.reverse) ? -1 : 1);
        ...
        _fade: function (_9, _a) {
            ...
            var _b = {duration: this.transitionDuration},
                _c = dojo.fx.combine([dojo["fadeOut"](dojo.mixin({node: _a.domNode}, _b)), dojo["fadeIn"](dojo.mixin({node: _9.domNode}, _b))]);
    ...
    dojo.declare("dojox.layout.RotatorPager", [dijit._Widget, dijit._Templated, dijit._Contained], {
        widgetsInTemplate: true, rotatorId: "", postMixInProperties: function () {
