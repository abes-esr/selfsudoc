...
if (!dojo._hasResource["dojox.layout.GridContainerLite"]) {
    ...
    dojo.declare("dojox.layout.GridContainerLite", [dijit.layout._LayoutWidget, dijit._Templated], {
        autoRefresh: true,
        ...
        _selectFocus: function (_30) {
            ...
            var key = _30.keyCode, k = dojo.keys, _31 = null, _32 = dijit.getFocus(), _33 = _32.node,
                m = this._dragManager, _34, i, j, r, _35, _36, _37;
