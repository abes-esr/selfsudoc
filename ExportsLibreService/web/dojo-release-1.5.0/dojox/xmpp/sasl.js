...
if (!dojo._hasResource["dojox.xmpp.sasl"]) {
    ...
    dojo.declare("dojox.xmpp.sasl._Base", null, {
        mechanism: null, closeAuthTag: true, constructor: function (_1) {
            this.session = _1;
            this.startAuth();
        }, startAuth: function () {
            var _2 = new dojox.string.Builder(dojox.xmpp.util.createElement("auth", {
    ...
    dojo.declare("dojox.xmpp.sasl.Plain", dojox.xmpp.sasl._Base, {
        mechanism: "PLAIN", closeAuthTag: false, appendToAuth: function (_5) {
    ...
    dojo.declare("dojox.xmpp.sasl.DigestMD5", dojox.xmpp.sasl._Base, {
        mechanism: "DIGEST-MD5", onFirstChallenge: function (_8) {
