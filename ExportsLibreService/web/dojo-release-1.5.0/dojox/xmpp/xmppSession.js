...
if (!dojo._hasResource["dojox.xmpp.xmppSession"]) {
    ...
    dojo.extend(dojox.xmpp.xmppSession, {
        roster: [], chatRegister: [], _iqId: 0, open: function (_2, _3, _4) {
            if (!_2) {
            ...
            this.session.close(dojox.xmpp.util.createElement("presence", {
                type: "unavailable",
                xmlns: dojox.xmpp.xmpp.CLIENT_NS
            }, true));
            ...
            var re = {
                name: _22.getAttribute("name"),
                jid: _22.getAttribute("jid"),
                groups: [],
