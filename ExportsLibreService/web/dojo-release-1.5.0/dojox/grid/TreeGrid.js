...
if (!dojo._hasResource["dojox.grid.TreeGrid"]) {
    ...
    dojo.declare("dojox.grid._TreeAggregator", null, {
        cells: [], grid: null, childFields: [], constructor: function (_1) {
            this.cells = _1.cells || [];
    ...
    dojo.declare("dojox.grid._TreeLayout", dojox.grid._Layout, {
        _isCollapsable: false, _getInternalStructure: function (_1f) {
            var g = this.grid;
            var s = _1f;
            var _20 = s[0].cells[0];
    ...
    dojo.declare("dojox.grid._TreeFocusManager", dojox.grid._FocusManager, {
        setFocusCell: function (_4a, _4b) {
            ...
            var sc = this.grid.scroller, r = this.rowIndex, rc = this.grid.rowCount - 1,
                _55 = new dojox.grid.TreePath(this.rowIndex, this.grid);
            if (_53) {
                var row;
                if (_53 > 0) {
                    _55 = _55.next();
