...
if (!dojo._hasResource["dojox.grid.cells.tree"]) {
    ...
    dojox.grid.cells.TreeCell = {
        formatAggregate: function (_1, _2, _3) {
            var f, g = this.grid, i = g.edit.info,
                d = g.aggregator ? g.aggregator.getForCell(this, _2, _1, _2 === this.level ? "cnt" : this.parentCell.aggregate) : (this.value || this.defaultValue);
            return this._defaultFormat(d, [d, _2 - this.level, _3, this]);
        }, formatIndexes: function (_4, _5) {
            var f, g = this.grid, i = g.edit.info,
                d = this.get ? this.get(_4[0], _5, _4) : (this.value || this.defaultValue);
