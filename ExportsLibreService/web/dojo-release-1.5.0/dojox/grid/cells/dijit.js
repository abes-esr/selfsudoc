...
if (!dojo._hasResource["dojox.grid.cells.dijit"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.grid.cells._Widget", _1._Base, {
            widgetClass: dijit.form.TextBox, constructor: function (_2) {
                this.widget = null;
                ...
                return dojo.mixin({
                    dir: this.dir,
                    lang: this.lang
                }, this.widgetProps || {}, {constraints: dojo.mixin({}, this.constraint) || {}, value: _9});
        ...
        dojo.declare("dojox.grid.cells.ComboBox", _1._Widget, {
            widgetClass: dijit.form.ComboBox, getWidgetProps: function (_1e) {
                var _1f = [];
        ...
        dojo.declare("dojox.grid.cells.DateTextBox", _1._Widget, {
            widgetClass: dijit.form.DateTextBox, setValue: function (_24, _25) {
                if (this.widget) {
        ...
        dojo.declare("dojox.grid.cells.CheckBox", _1._Widget, {
            widgetClass: dijit.form.CheckBox, getValue: function () {
        ...
        dojo.declare("dojox.grid.cells.Editor", _1._Widget, {
            widgetClass: dijit.Editor, getWidgetProps: function (_30) {
