...
if (!dojo._hasResource["dojox.grid.cells._base"]) {
    ...
    dojo.declare("dojox.grid._DeferredTextWidget", dijit._Widget, {
        deferred: null, _destroyOnRemove: true, postCreate: function () {
            if (this.deferred) {
    ...
    (function () {
        ...
        dojo.declare("dojox.grid.cells.Cell", _5._Base, {
        ...
        dojo.declare("dojox.grid.cells.RowIndex", _5.Cell, {
            name: "Row", postscript: function () {
                this.editable = false;
            }, get: function (_3d) {
                return _3d + 1;
            }
        ...
        dojo.declare("dojox.grid.cells.Select", _5.Cell, {
            options: null, values: null, returnIndex: -1, constructor: function (_40) {
        ...
        dojo.declare("dojox.grid.cells.AlwaysEdit", _5.Cell, {
            alwaysEditing: true, _formatNode: function (_48, _49) {
        ...
        dojo.declare("dojox.grid.cells.Bool", _5.AlwaysEdit, {
            _valueProp: "checked", formatEditing: function (_4d, _4e) {
