...
if (!dojo._hasResource["dojox.grid._TreeView"]) {
                ...
                if (!_a && _9) {
                    if (_6) {
                        ...
                        if (_e && !_9.isItemLoaded(_e.item)) {
                            ...
                            dojo.addClass(this.domNode, "dojoxGridExpandoLoading");
                            _9.loadItem({
                                item: _e.item, onItem: dojo.hitch(this, function (i) {
    ...
    dojo.declare("dojox.grid._TreeContentBuilder", dojox.grid._ContentBuilder, {
        generateHtml: function (_17, _18) {
            var _19 = this.getTableArray(), v = this.view, row = v.structure.cells[0], _1a = this.grid.getItem(_18),
                _1b = this.grid, _1c = this.grid.store;
    ...
    dojo.declare("dojox.grid._TreeView", [dojox.grid._View], {
        _contentBuilderClass: dojox.grid._TreeContentBuilder, _onDndDrop: function (_3c, _3d, _3e) {
