        ...
        dojo.declare("dojox.grid._Grid", [dijit._Widget, dijit._Templated, dojox.grid._Events], {
            ...
            getColumnTogglingItems: function () {
                return dojo.map(this.layout.cells, function (_9) {
                    ...
                    var _a = this;
                    var _b = new dijit.CheckedMenuItem({
                        label: _9.name, checked: !_9.hidden, _gridCell: _9, onChange: function (_c) {
            ...
            adaptWidth: function () {
                ...
                var w = _1b ? 0 : this.domNode.clientWidth || (this.domNode.offsetWidth - this._getPadBorder().w),
