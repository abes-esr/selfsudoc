...
if (!dojo._hasResource["dojox.grid.enhanced.dnd._DndFocusManager"]) {
    ...
    dojo.declare("dojox.grid.enhanced.dnd._DndFocusManager", null, {
        _rowBarNode: null, _rowBarFocusIdy: null, isRowBar: function () {
            ...
            var sc = this.grid.scroller, r = this._rowBarFocusIdy, rc = this.grid.rowCount - 1,
                _4 = Math.min(rc, Math.max(0, r + 1));
