...
if (!dojo._hasResource["dojox.grid.enhanced.plugins.NestedSorting"]) {
    ...
    dojo.declare("dojox.grid.enhanced.plugins.NestedSorting", null, {
        ...
        getCellSortInfo: function (_b) {
            ...
            return _c ? _c : {
                unarySortAsc: _d && _d[0] ? _d[0]["asc"] : undefined,
        ...
        _getSortEventInfo: function (e) {
            ...
            return {
                selectChoice: _6b(e.target, "dojoxGridHeaderCellSelectRegion"),
                unarySortChoice: _6b(e.target, "dojoxGridUnarySortWrapper"),
                nestedSortChoice: _6b(e.target, "dojoxGridNestedSortWrapper")
            };
        },
    ...
    dojo.declare("dojox.grid.enhanced.plugins._NestedSortingFocusManager", dojox.grid._FocusManager, {
        ...
        _addFocusBorder: function (_b4) {
            ...
            var pos = {
                x: dojo.coords(_b4).x - dojo.coords(this._focusBorderBox).x,
                y: dojo.coords(_b4).y - dojo.coords(this._focusBorderBox).y,
                w: _b4.offsetWidth,
                h: _b5
            };
            for (var i in _b6) {
