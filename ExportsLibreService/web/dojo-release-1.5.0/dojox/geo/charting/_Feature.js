...
if (!dojo._hasResource["dojox.geo.charting._Feature"]) {
    ...
    dojo.declare("dojox.geo.charting._Feature", null, {
        _isZoomIn: false, _isFocused: false, markerText: null, constructor: function (_1, _2, _3) {
            this.id = _2;
            ...
            var _11 = dojox.gfx.fx.animateTransform({
                duration: 1000,
                shape: this.mapObj,
                transform: [{
                    name: "translate",
            ...
            var _12 = dojox.gfx.fx.animateTransform({
                duration: 1000,
                shape: this.mapObj,
                transform: [{
                    name: "translate",
