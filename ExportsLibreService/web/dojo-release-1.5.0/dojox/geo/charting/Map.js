...
if (!dojo._hasResource["dojox.geo.charting.Map"]) {
    ...
    dojo.declare("dojox.geo.charting.Map", null, {
        defaultColor: "#B7B7B7", highlightColor: "#D5D5D5", series: [], constructor: function (_1, _2) {
            dojo.style(_1, "display", "block");
            this.containerSize = {
                x: dojo.coords(_1).x,
                y: dojo.coords(_1).y,
                w: dojo.coords(_1).w || 100,
                h: dojo.coords(_1).h || 100
            };
            ...
            this.dataStore.fetch({
                query: _5, onComplete: function (_7) {
                    var _8 = _7[0];
