    ...
    (function () {
        ...
        function _4(p, _5, _6) {
            ...
            dojo.forEach(p.colors, function (_8) {
                var r = (_5 == "dr") ? _8.r + _6 : _8.r, g = (_5 == "dg") ? _8.g + _6 : _8.g,
                    b = (_5 == "db") ? _8.b + _6 : _8.b, a = (_5 == "da") ? _8.a + _6 : _8.a;
                _7.colors.push(new dojox.color.Color({
        ...
        function _9(p, _a, _b) {
            ...
            dojo.forEach(p.colors, function (_d) {
                var o = _d.toCmy(), c = (_a == "dc") ? o.c + _b : o.c, m = (_a == "dm") ? o.m + _b : o.m,
                    y = (_a == "dy") ? o.y + _b : o.y;
        ...
        function _e(p, _f, val) {
            ...
            dojo.forEach(p.colors, function (_10) {
                var o = _10.toCmyk(), c = (_f == "dc") ? o.c + val : o.c, m = (_f == "dm") ? o.m + val : o.m,
                    y = (_f == "dy") ? o.y + val : o.y, k = (_f == "dk") ? o.b + val : o.b;
        ...
        function _11(p, _12, val) {
            ...
            dojo.forEach(p.colors, function (_13) {
                var o = _13.toHsl(), h = (_12 == "dh") ? o.h + val : o.h, s = (_12 == "ds") ? o.s + val : o.s,
                    l = (_12 == "dl") ? o.l + val : o.l;
        ...
        function _14(p, _15, val) {
            ...
            dojo.forEach(p.colors, function (_16) {
                var o = _16.toHsv(), h = (_15 == "dh") ? o.h + val : o.h, s = (_15 == "ds") ? o.s + val : o.s,
                    v = (_15 == "dv") ? o.v + val : o.v;
        ...
        dojo.extend(_1.Palette, {
            transform: function (_19) {
                var fn = _4;
                if (_19.use) {
        ...
        dojo.mixin(_1.Palette, {
            generators: {
                analogous: function (_1b) {
                    var _1c = _1b.high || 60, low = _1b.low || 18,
                        _1d = dojo.isString(_1b.base) ? new dojox.color.Color(_1b.base) : _1b.base, hsv = _1d.toHsv();
                    ...
                    var s1 = Math.max(10, (hsv.s <= 95) ? hsv.s + 5 : (100 - (hsv.s - 95))),
                        ...
                        s = [s1, s2, hsv.s, s1, s1], v = [v1, v2, hsv.v, v1, v2];
                    ...
                    var s1 = (hsv.s - 30 > 9) ? hsv.s - 30 : hsv.s + 30, s2 = hsv.s, v1 = _17(hsv.v, 20, 100),
                    ...
                    var h1 = (hsv.h + 57 + 360) % 360, h2 = (hsv.h - 157 + 360) % 360,
                        s1 = (hsv.s > 20) ? hsv.s - 10 : hsv.s + 10, s2 = (hsv.s > 90) ? hsv.s - 10 : hsv.s + 10,
                        s3 = (hsv.s > 95) ? hsv.s - 5 : hsv.s + 5, v1 = (hsv.v - 20 > 20) ? hsv.v - 20 : hsv.v + 20,
                    ...
                    var h1 = ((hsv.h * 2) + 137 < 360) ? (hsv.h * 2) + 137 : Math.floor(hsv.h / 2) - 137,
                        s1 = Math.max(hsv.s - 10, 0), s2 = _17(hsv.s, 10, 100), s3 = Math.min(100, hsv.s + 20),
                        v1 = Math.min(100, hsv.v + 30), v2 = (hsv.v > 20) ? hsv.v - 30 : hsv.v + 30;
                    ...
                    var _25 = dojo.isString(_24.base) ? new dojox.color.Color(_24.base) : _24.base, _26 = _24.da || 30,
                        hsv = _25.toHsv();
                    var _27 = ((hsv.h * 2) + 137 < 360) ? (hsv.h * 2) + 137 : Math.floor(hsv.h / 2) - 137,
                        h1 = (_27 - _26 + 360) % 360, h2 = (_27 + _26) % 360, s1 = Math.max(hsv.s - 10, 0),
                        s2 = _17(hsv.s, 10, 100), s3 = Math.min(100, hsv.s + 20), v1 = Math.min(100, hsv.v + 30),
                    ...
                    var s = (hsv.s == 100 && hsv.v == 0) ? 0 : hsv.s, v1 = (hsv.v - 50 > 20) ? hsv.v - 50 : hsv.v + 30,
                        v2 = (hsv.v - 25 >= 20) ? hsv.v - 25 : hsv.v + 55,
                        v3 = (hsv.v - 75 >= 20) ? hsv.v - 75 : hsv.v + 5, v4 = Math.max(hsv.v - 10, 20);
