        ...
        function _18(_1b, _1c, _1d, _1e) {
            ...
            for (i in _1b) {
                if (_1b.hasOwnProperty(i) && !(i.charAt(0) == "_" && i.charAt(1) == "_") && _1c && !_1c[i] && _1e === false) {
                    _b.push({
                        property: _1d,
                        message: (typeof _1f) + "The property " + i + " is not defined in the schema and the schema does not allow additional properties"
                    });
                }
                ...
                if (_21 && !(_21 in _1b)) {
                    _b.push({
                        property: _1d,
                        message: "the presence of the property " + i + " requires that " + _21 + " also be present"
                    });
                }
                _1f = _1b[i];
