...
if (!dojo._hasResource["dojox.atom.io.Connection"]) {
    ...
    dojo.declare("dojox.atom.io.Connection", null, {
        constructor: function (_1, _2) {
            ...
            var _16 = {
                url: _f, handleAs: "xml", sync: this.sync, preventCache: this.preventCache, load: function (_17, _18) {
                    var _19 = null;
                    var _1a = _17;
                    var _1b;
                    if (_1a) {
