    ...
    dojo.declare("dojox.atom.widget.FeedEntryEditor", dojox.atom.widget.FeedEntryViewer, {
        ...
        setContributors: function (_f, _10, _11) {
            if (!_10) {
                ...
                if (_11.contributors && _11.contributors.length > 0) {
                    this._editors.contributors = this._createPeopleEditor(this.entryContributorNode, {
                        data: _11.contributors,
                        name: "Contributor"
                    });
                    this.setFieldValidity("contributors", true);
                }
        ...
        _createEditor: function (_20, _21, _22, rte) {
            ...
            if (!_21) {
                if (rte) {
                    return {
                        anchorNode: _20, entryValue: "", editor: null, generateEditor: function () {
            ...
            if (rte) {
                ...
                return {
                    anchorNode: _20, entryValue: _26, editor: null, generateEditor: function () {
    ...
    dojo.declare("dojox.atom.widget.PeopleEditor", [dijit._Widget, dijit._Templated, dijit._Container], {
        ...
        getValues: function () {
            ...
            for (var i in this._editors) {
                if (this._editors[i]) {
                    _66.push({
                        name: this._editors[i][0].attr("value"),
                        email: this._editors[i][1].attr("value"),
                        uri: this._editors[i][2].attr("value")
                    });
                }
            }
            return _66;
