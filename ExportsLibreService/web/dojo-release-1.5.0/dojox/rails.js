...
if (!dojo._hasResource["dojox.rails"]) {
    ...
    dojo.ready((function (d, dr, dg) {
        return function () {
            var q = d.query, _9 = dr.live, _a = q("meta[name=csrf-token]").attr("content"),
                _b = q("meta[name=csrf-param]").attr("content");
            ...
            var _17 = function (evt) {
                ...
                var _18 = tag.toLowerCase() == "form" ? d.formToObject(el) : {},
                    _19 = d.attr(el, "data-type") || "javascript",
                    _1a = (d.attr(el, "method") || d.attr(el, "data-method") || "get").toLowerCase(),
                ...
                var _1b = d.xhr(_1a, {
                    url: url, headers: {"Accept": _16[_19]}, content: _18, handleAs: _19, load: function (_1c, _1d) {
