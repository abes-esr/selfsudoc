...
if (!dojo._hasResource["dojox.editor.plugins.NormalizeIndentOutdent"]) {
    ...
    dojo.declare("dojox.editor.plugins.NormalizeIndentOutdent", dijit._editor._Plugin, {
        indentBy: 40, indentUnits: "px", setEditor: function (_1) {
            this.editor = _1;
    ...
    dojo.subscribe(dijit._scopeName + ".Editor.getPlugin", null, function (o) {
        ...
        if (_36 === "normalizeindentoutdent") {
            o.plugin = new dojox.editor.plugins.NormalizeIndentOutdent({
                indentBy: ("indentBy" in o.args) ? (o.args.indentBy > 0 ? o.args.indentBy : 40) : 40,
                indentUnits: ("indentUnits" in o.args) ? (o.args.indentUnits.toLowerCase() == "em" ? "em" : "px") : "px"
            });
        }
    });
}
