...
if (!dojo._hasResource["dojox.editor.plugins._SmileyPalette"]) {
    ...
    dojo.declare("dojox.editor.plugins._SmileyPalette", [dijit._Widget, dijit._Templated, dijit._PaletteMixin], {
        ...
        _palette: [["smile", "laughing", "wink", "grin"], ["cool", "angry", "half", "eyebrow"], ["frown", "shy", "goofy", "oops"], ["tongue", "idea", "angel", "happy"], ["yes", "no", "crying", ""]],
    ...
    dojo.declare("dojox.editor.plugins.Emoticon", null, {
        constructor: function (id) {
            this.id = id;
        }, getValue: function () {
            return dojox.editor.plugins.Emoticon.ascii[this.id];
        }, imgHtml: function (_4) {
            var _5 = "emoticon" + this.id.substr(0, 1).toUpperCase() + this.id.substr(1),
                _6 = dojo.moduleUrl("dojox.editor.plugins", "resources/emoticons/" + _5 + ".gif"),
                _7 = dojo.i18n.getLocalization("dojox.editor.plugins", "Smiley")[_5],
                _8 = ["<img src=\"", _6, "\" class=\"", _4, "\" alt=\"", this.getValue(), "\" title=\"", _7, "\">"];
            return _8.join("");
