...
if (!dojo._hasResource["dojox.editor.plugins.PrettyPrint"]) {
    ...
    dojo.declare("dojox.editor.plugins.PrettyPrint", dijit._editor._Plugin, {
        indentBy: -1, lineLength: -1, useDefaultCommand: false, entityMap: null, _initButton: function () {
            delete this.command;
    ...
    dojo.subscribe(dijit._scopeName + ".Editor.getPlugin", null, function (o) {
        ...
        if (_7 === "prettyprint") {
            o.plugin = new dojox.editor.plugins.PrettyPrint({
                ...
                entityMap: ("entityMap" in o.args) ? o.args.entityMap : dojox.html.entities.html.concat([["¢", "cent"], ["£", "pound"], ["€", "euro"], ["¥", "yen"], ["©", "copy"], ["§", "sect"], ["…", "hellip"], ["®", "reg"]]),
