...
if (!dojo._hasResource["dojox.editor.plugins.CollapsibleToolbar"]) {
    ...
    dojo.declare("dojox.editor.plugins._CollapsibleToolbarButton", [dijit._Widget, dijit._Templated], {
        templateString: "<div tabindex='0' role='button' title='${title}' class='${buttonClass}' " + "dojoAttachEvent='ondijitclick: onClick'><span class='${textClass}'>${text}</span></div>",
        title: "",
        buttonClass: "",
        text: "",
        textClass: "",
    ...
    dojo.declare("dojox.editor.plugins.CollapsibleToolbar", dijit._editor._Plugin, {
        _myWidgets: null, setEditor: function (_1) {
            this.editor = _1;
            ...
            this._myWidgets = [];
            var _3 = dojo.create("table", {
                style: {width: "100%"},
                tabindex: -1,
                "class": "dojoxCollapsibleToolbarContainer"
            });
            ...
            var _9 = new dojox.editor.plugins._CollapsibleToolbarButton({
            ...
            var _a = new dojox.editor.plugins._CollapsibleToolbarButton({
