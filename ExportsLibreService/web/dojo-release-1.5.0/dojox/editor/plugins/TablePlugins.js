...
if (!dojo._hasResource["dojox.editor.plugins.TablePlugins"]) {
    ...
    dojo.declare("dojox.editor.plugins._TableHandler", dijit._editor._Plugin, {
        ...
        doMixins: function () {
            dojo.mixin(this.editor, {
                getAncestorElement: function (_1) {
    ...
    dojo.declare("dojox.editor.plugins.TableContextMenu", dojox.editor.plugins.TablePlugins, {
        constructor: function () {
            ...
            _21.addChild(new dijit.MenuItem({
                label: _22.insertTableRowBeforeLabel,
                onClick: dojo.hitch(this, "modTable", "insertTableRowBefore")
            }));
            _21.addChild(new dijit.MenuItem({
                label: _22.insertTableRowAfterLabel,
                onClick: dojo.hitch(this, "modTable", "insertTableRowAfter")
            }));
            _21.addChild(new dijit.MenuItem({
                label: _22.insertTableColumnBeforeLabel,
                onClick: dojo.hitch(this, "modTable", "insertTableColumnBefore")
            }));
            _21.addChild(new dijit.MenuItem({
                label: _22.insertTableColumnAfterLabel,
                onClick: dojo.hitch(this, "modTable", "insertTableColumnAfter")
            }));
            _21.addChild(new dijit.MenuSeparator());
            _21.addChild(new dijit.MenuItem({
                label: _22.deleteTableRowLabel,
                onClick: dojo.hitch(this, "modTable", "deleteTableRow")
            }));
            _21.addChild(new dijit.MenuItem({
                label: _22.deleteTableColumnLabel,
                onClick: dojo.hitch(this, "modTable", "deleteTableColumn")
            }));
            this.menu = _21;
        }
    });
    dojo.declare("dojox.editor.plugins.InsertTable", dojox.editor.plugins.TablePlugins, {
        alwaysAvailable: true, modTable: function () {
    ...
    dojo.declare("dojox.editor.plugins.ModifyTable", dojox.editor.plugins.TablePlugins, {
        modTable: function () {
    ...
    dojo.declare("dojox.editor.plugins.EditorTableDialog", [dijit.Dialog], {
        ...
        onInsert: function () {
            var _27 = this.selectRow.get("value") || 1, _28 = this.selectCol.get("value") || 1,
                _29 = this.selectWidth.get("value"), _2a = this.selectWidthType.get("value"),
                _2b = this.selectBorder.get("value"), pad = this.selectPad.get("value"),
                _2c = this.selectSpace.get("value"), _2d = "tbl_" + (new Date().getTime()),
                t = "<table id=\"" + _2d + "\"width=\"" + _29 + ((_2a == "percent") ? "%" : "") + "\" border=\"" + _2b + "\" cellspacing=\"" + _2c + "\" cellpadding=\"" + pad + "\">\n";
            for (var r = 0; r < _27; r++) {
                t += "\t<tr>\n";
                for (var c = 0; c < _28; c++) {
