...
if (!dojo._hasResource["dojox.editor.plugins.Breadcrumb"]) {
    ...
    dojo.declare("dojox.editor.plugins.Breadcrumb", dijit._editor._Plugin, {
        _menu: null, breadcrumbBar: null, setEditor: function (_4) {
            this.editor = _4;
            this._buttons = [];
            ...
            this.editor.onLoadDeferred.addCallback(dojo.hitch(this, function () {
                ...
                var _6 = this;
                var _7 = new dijit.form.ComboButton({
                    showLabel: true,
                    label: "body",
                    _selNode: _4.editNode,
                    dropDown: this._menu,
