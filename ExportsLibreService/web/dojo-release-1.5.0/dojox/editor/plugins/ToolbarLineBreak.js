...
if (!dojo._hasResource["dojox.editor.plugins.ToolbarLineBreak"]) {
    ...
    dojo.declare("dojox.editor.plugins._ToolbarLineBreak", [dijit._Widget, dijit._Templated], {
        templateString: "<span class='dijit dijitReset'><br></span>", postCreate: function () {
    ...
    dojo.subscribe(dijit._scopeName + ".Editor.getPlugin", null, function (o) {
        ...
        if (_1 === "||" || _1 === "toolbarlinebreak") {
            o.plugin = new dijit._editor._Plugin({
                button: new dojox.editor.plugins._ToolbarLineBreak(), setEditor: function (_2) {
                    this.editor = _2;
                }
            });
        }
