...
if (!dojo._hasResource["dojox.data.ItemExplorer"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.data.ItemExplorer", dijit.Tree, {
            useSelect: false, refSelectSearchAttr: null, constructor: function (_6) {
                dojo.mixin(this, _6);
                var _7 = this;
                var _8 = {};
                        ...
                        function _16() {
                            ...
                            if (_10) {
                                for (var key, k = 0; key = _10[k++];) {
                                    _13.push({
                                        property: key,
                                        value: _14 ? _1(_7.store, _12, key) : _12[key],
                                        parent: _11
                                    });
                                }
                ...
                _31.appendChild(_32);
                var _33 = new dijit.form.ValidationTextBox({
                    name: "property",
                    value: "",
                    required: true,
                    disabled: true
                ...
                _31.appendChild(dojo.doc.createElement("br"));
                var _34 = new dijit.form.RadioButton({
                    name: "itemType", value: "value", onClick: dojo.hitch(this, function () {
                ...
                _31.appendChild(_36);
                var _38 = new dijit.form.RadioButton({
                    name: "itemType", value: "reference", onClick: dojo.hitch(this, function () {
                ...
                if (this.useSelect) {
                    var _3b = new dijit.form.FilteringSelect({
                        name: "_reference",
                        store: this.store,
                    ...
                    var _3c = new dijit.form.ValidationTextBox({
                        name: "_reference",
                        value: "",
                        promptMessage: "Enter the ID of the item to reference",
                        isValid: dojo.hitch(this, function (_3d) {
                            return true;
                        })
                    }).placeAt(_3a);
                }
                    ...
                    switch (_46.itemType) {
                        case "reference":
                            this.store.fetchItemByIdentity({
                                identity: _46._reference, onItem: function (_53) {
                                    val = _53;
                                    _4d();
                                }, onError: function () {
