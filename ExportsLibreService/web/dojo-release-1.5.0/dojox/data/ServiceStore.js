...
if (!dojo._hasResource["dojox.data.ServiceStore"]) {
    ...
    dojo.declare("dojox.data.ServiceStore", dojox.data.ClientFilter || null, {
        ...
        _currentId: 0,
        _processResults: function (_16, _17) {
            ...
            return {
                totalCount: _17.request.count == _19 ? (_17.request.start || 0) + _19 * this.estimateCountFactor : _19,
                items: _16
            };
        },
        close: function (_1a) {
        ...
        fetch: function (_1b) {
            ...
            _1e.addCallback(function (_1f) {
                if (_1b.clientFetch) {
                    _1f = _1c.clientSideFetch({
                        query: _1b.clientFetch,
                        sort: _1b.sort,
                        start: _1b.start,
                        count: _1b.count
                    }, _1f);
