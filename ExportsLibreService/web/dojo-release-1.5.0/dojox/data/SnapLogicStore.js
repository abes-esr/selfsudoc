...
if (!dojo._hasResource["dojox.data.SnapLogicStore"]) {
    ...
    dojo.declare("dojox.data.SnapLogicStore", null, {
        Parts: {DATA: "data", COUNT: "count"}, url: "", constructor: function (_1) {
            if (_1.url) {
                this.url = _1.url;
            }
            ...
            if (_1d.onItem || _1d.onComplete) {
                ...
                var _23 = {
                    ...
                    handle: dojo.hitch(this, "_partHandler", _1d, this.Parts.DATA)
                };
            ...
            if (_1d.onBegin) {
                ...
                var _23 = {
                    ...
                    timeout: 60000,
                    callbackParamName: "sn.stream_header",
                    handle: dojo.hitch(this, "_partHandler", _1d, this.Parts.COUNT)
                };
