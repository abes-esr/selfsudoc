...
if (!dojo._hasResource["dojox.data.FlickrRestStore"]) {
    ...
    dojo.declare("dojox.data.FlickrRestStore", dojox.data.FlickrStore, {
        ...
        _prevRequests: null,
        _handlers: null,
        _sortAttributes: {"date-posted": true, "date-taken": true, "interestingness": true},
        _fetchItems: function (_2, _3, _4) {
            var _5 = {};
            if (!_2.query) {
                _2.query = _5 = {};
            } else {
            ...
            _2 = {
                ...
                count: _2._curCount,
                start: _2._curStart,
                _realCount: _2._realCount,
                _realStart: _2._realStart,
                onBegin: _2.onBegin,
                onComplete: _2.onComplete,
                onItem: _2.onItem
            };
            ...
            var _1a = dojo.hitch(this, function (_1b) {
                if (_1b.stat != "ok") {
                    ...
                    this._prevRequestRanges[_6].push({
                        start: _2.start,
                        end: _2.start + (_1b.photoset ? _1b.photoset.photo.length : _1b.photos.photo.length)
                    });
