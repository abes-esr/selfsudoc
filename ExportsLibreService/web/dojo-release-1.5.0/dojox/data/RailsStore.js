...
if (!dojo._hasResource["dojox.data.RailsStore"]) {
    ...
    dojo.declare("dojox.data.RailsStore", dojox.data.JsonRestStore, {
        constructor: function () {
                ...
                var _3 = function (id, _4) {
                    ...
                    return {
                        ...
                        headers: {
                            ...
                            Range: _4 && (_4.start >= 0 || _4.count >= 0) ? "items=" + (_4.start || "0") + "-" + ((_4.count && (_4.count + (_4.start || 0) - 1)) || "") : undefined
                        }
                    };
                };
            ...
            var _15 = _10.length;
            return {
                totalCount: _11.fullLength || (_11.request.count == _15 ? (_11.request.start || 0) + _15 * 2 : _15),
                items: _12
            };
        }
    });
