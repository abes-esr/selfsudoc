...
if (!dojo._hasResource["dojox.highlight.languages.django"]) {
    ...
    (function () {
        ...
        _2.django = {
            defaultMode: {contains: ["tag", "comment", "doctype", "template_comment", "template_tag", "variable"]},
            case_insensitive: true,
            modes: [x.XML_COMMENT, h.HTML_DOCTYPE, {
                className: "tag",
                lexems: [_1.IDENT_RE],
            ...
            }, {className: "template_comment", begin: "\\{#", end: "#\\}"}, {
                ...
                contains: ["filter"]
            }, {className: "variable", begin: "\\{\\{", end: "\\}\\}", contains: ["filter"]}, {
                className: "filter",
                begin: "\\|[A-Za-z]+\\:?",
                end: "^",
                excludeEnd: true,
