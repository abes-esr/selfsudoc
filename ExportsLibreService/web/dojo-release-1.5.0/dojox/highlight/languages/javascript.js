...
if (!dojo._hasResource["dojox.highlight.languages.javascript"]) {
    ...
    (function () {
        ...
        dh.languages.javascript = {
            ...
            modes: [_1.C_LINE_COMMENT_MODE, _1.C_BLOCK_COMMENT_MODE, _1.C_NUMBER_MODE, _1.APOS_STRING_MODE, _1.QUOTE_STRING_MODE, _1.BACKSLASH_ESCAPE, {
                className: "regexp",
                begin: "/.*?[^\\\\/]/[gim]*",
                end: "^"
            }, {
            ...
            }, {className: "title", begin: _1.UNDERSCORE_IDENT_RE, end: "^"}, {
                className: "params",
                begin: "\\(",
                end: "\\)",
