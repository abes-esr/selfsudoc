    ...
    (function () {
        ...
        dh.languages.sql = {
            ...
            defaultMode: {
                ...
                keywords: {"keyword": _1, "aggregate": {"count": 1, "sum": 1, "min": 1, "max": 1, "avg": 1}}
            },
            modes: [_2.C_NUMBER_MODE, _2.C_BLOCK_COMMENT_MODE, {
                className: "comment",
                begin: "--",
                end: "$"
            }, {
                ...
                relevance: 0
            }, {className: "squote", begin: "''", end: "^"}, {
                className: "string",
                begin: "\"",
                end: "\"",
                contains: ["escape", "dquote"],
                relevance: 0
            }, {className: "dquote", begin: "\"\"", end: "^"}, {
                className: "string",
                begin: "`",
                end: "`",
                contains: ["escape"]
