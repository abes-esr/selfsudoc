...
if (!dojo._hasResource["dojox.validate._base"]) {
    ...
    dojox.validate.isInRange = function (_3, _4) {
        ...
        var _5 = (typeof _4.max == "number") ? _4.max : Infinity, _6 = (typeof _4.min == "number") ? _4.min : -Infinity,
            _7 = (typeof _4.decimal == "string") ? _4.decimal : ".", _8 = dojox.validate._isInRangeCache,
            _9 = _3 + "max" + _5 + "min" + _6 + "dec" + _7;
