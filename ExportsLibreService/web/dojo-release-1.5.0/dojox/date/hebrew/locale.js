        ...
        dojox.date.hebrew.locale.parse = function (_22, _23) {
            ...
            var _2f = dojo.every(_27, function (v, i) {
                ...
                switch (_30.charAt(0)) {
                    ...
                    case "M":
                        if (l > 2) {
                            var _31 = dojox.date.hebrew.locale.getNames("months", _2e[l - 3], "format", _28, new dojox.date.hebrew.Date(5769, 1, 1)),
                                _32 = dojox.date.hebrew.locale.getNames("months", _2e[l - 3], "format", _28, new dojox.date.hebrew.Date(5768, 1, 1));
                            if (!_23.strict) {
                    ...
                    case "d":
                        ...
                        break;
                    case "a":
                        var am = _23.am || _26["dayPeriods-format-wide-am"],
                            pm = _23.pm || _26["dayPeriods-format-wide-pm"];
                        if (!_23.strict) {
                            var _34 = /\./g;
            ...
            return _42.replace(/([a-z])\1*/ig, function (_44) {
                ...
                switch (c) {
                    ...
                    case "S":
                        ...
                        break;
                    case "a":
                        var am = _41.am || _40["dayPeriods-format-wide-am"],
                            pm = _41.pm || _40["dayPeriods-format-wide-pm"];
                        if (_41.strict) {
                            s = am + "|" + pm;
                        } else {
                            s = am + "|" + pm;
