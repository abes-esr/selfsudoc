...
if (!dojo._hasResource["dojox.date.hebrew.Date"]) {
    ...
    dojo.declare("dojox.date.hebrew.Date", null, {
        ...
        _startOfYear: function (_19) {
            var _1a = Math.floor((235 * _19 - 234) / 19), _1b = _1a * (12 * 1080 + 793) + 11 * 1080 + 204,
                day = _1a * 29 + Math.floor(_1b / (24 * 1080));
            _1b %= 24 * 1080;
            var wd = day % 7;
            if (wd == 2 || wd == 4 || wd == 6) {
                day += 1;
        ...
        _computeHebrewFields: function (_1f) {
            var _20 = this._getJulianDayFromGregorianDate(_1f), d = _20 - 347997,
                m = Math.floor((d * 24 * 1080) / (29 * 24 * 1080 + 12 * 1080 + 793)),
                _21 = Math.floor((19 * m + 234) / 235) + 1, ys = this._startOfYear(_21), _22 = (d - ys);
            while (_22 < 1) {
                _21--;
                ys = this._startOfYear(_21);
                _22 = d - ys;
            }
            var _23 = this._yearType(_21), _24 = this.isLeapYear(_21) ? this._LEAP_MONTH_START : this._MONTH_START,
                _25 = 0;
        ...
        toGregorian: function () {
            ...
            var rem = [];
            var _2c = this._floorDivide(_2b, 146097, rem), _2d = this._floorDivide(rem[0], 36524, rem),
                n4 = this._floorDivide(rem[0], 1461, rem), n1 = this._floorDivide(rem[0], 365, rem),
                _2e = 400 * _2c + 100 * _2d + 4 * n4 + n1, _2f = rem[0];
            if (_2d == 4 || n1 == 4) {
                _2f = 365;
            } else {
                ++_2e;
        ...
        _getJulianDayFromGregorianDate: function (_3c) {
            var _3d = _3c.getFullYear(), _3e = _3c.getMonth(), d = _3c.getDate(),
                _3f = !(_3d % 4) && (_3d % 100 || !(_3d % 400)), y = _3d - 1;
