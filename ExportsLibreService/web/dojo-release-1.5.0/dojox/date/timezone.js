...
if (!dojo._hasResource["dojox.date.timezone"]) {
    ...
    (function (_1) {
        ...
        var _18 = {
            ...
            "nov": 10,
            "dec": 11
        }, _19 = {"sun": 0, "mon": 1, "tue": 2, "wed": 3, "thu": 4, "fri": 5, "sat": 6}, _1a = {
            "EST": "northamerica",
            "MST": "northamerica",
            "HST": "northamerica",
        ...
        function _2f(tz, _30) {
            ...
            for (var i = 0; i < _30.length; i++) {
                ...
                if (!z[3]) {
                    ...
                    var _37 = parseInt(z[3], 10), _38 = _22(z[4] || "Jan"), day = parseInt(z[5] || "1", 10),
                        _39 = _20(z[6] || "0");
        ...
        _1.setObject("dojox.date.timezone", {
            getTzInfo: function (dt, tz) {
                if (_b == "lazyLoad") {
                    var _4a = _1e(tz);
                    if (!_4a) {
