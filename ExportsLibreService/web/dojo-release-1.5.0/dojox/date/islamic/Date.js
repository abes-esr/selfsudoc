...
if (!dojo._hasResource["dojox.date.islamic.Date"]) {
    ...
    dojo.declare("dojox.date.islamic.Date", null, {
        ...
        toGregorian: function () {
            ...
            var wjd = Math.floor(_13 - 0.5) + 0.5, _14 = wjd - this._GREGORIAN_EPOCH, _15 = Math.floor(_14 / 146097),
                dqc = this._mod(_14, 146097), _16 = Math.floor(dqc / 36524), _17 = this._mod(dqc, 36524),
                _18 = Math.floor(_17 / 1461), _19 = this._mod(_17, 1461), _1a = Math.floor(_19 / 365),
                _1b = (_15 * 400) + (_16 * 100) + (_18 * 4) + _1a;
            if (!(_16 == 4 || _1a == 4)) {
                _1b++;
            }
