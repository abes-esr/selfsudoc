...
if (!dojo._hasResource["dojox.charting.axis2d.Invisible"]) {
    ...
    (function () {
        var dc = dojox.charting, df = dojox.lang.functional, du = dojox.lang.utils, g = dojox.gfx,
            _1 = dc.scaler.linear, _2 = du.merge, _3 = 4, _4 = 45;
        dojo.declare("dojox.charting.axis2d.Invisible", dojox.charting.axis2d.Base, {
            ...
            calculate: function (_c, _d, _e, _f) {
                ...
                var ta = this.chart.theme.axis, _10 = 0, _11 = o.rotation % 360,
                    _12 = o.font || (ta.majorTick && ta.majorTick.font) || (ta.tick && ta.tick.font),
                    _13 = _12 ? g.normalizedLength(g.splitFontString(_12).size) : 0,
                    _14 = Math.abs(Math.cos(_11 * Math.PI / 180)), _15 = Math.abs(Math.sin(_11 * Math.PI / 180));
                if (_11 < 0) {
                    _11 += 360;
                }
                if (_13) {
                    if (this.vertical ? _11 != 0 && _11 != 180 : _11 != 90 && _11 != 270) {
                        if (o.maxLabelSize) {
                            ...
                            if (this.labels) {
                                ...
                                var _16 = Math.ceil(Math.log(Math.max(Math.abs(tsb.from), Math.abs(tsb.to))) / Math.LN10),
                                    t = [];
                    ...
                    switch (_11) {
                        ...
                        case 270:
                            break;
                        default:
                            var _18 = Math.sqrt(_10 * _10 + _13 * _13),
                                _19 = this.vertical ? _13 * _14 + _10 * _15 : _10 * _14 + _13 * _15;
