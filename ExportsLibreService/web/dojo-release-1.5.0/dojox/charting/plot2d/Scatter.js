...
if (!dojo._hasResource["dojox.charting.plot2d.Scatter"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Scatter", dojox.charting.plot2d.Base, {
            defaultParams: {hAxis: "x", vAxis: "y", shadows: null, animate: null},
            optionalParams: {
                markerStroke: {},
                markerOutline: {},
                markerShadow: {},
            ...
            render: function (_4, _5) {
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    var _9 = t.next("marker", [this.opt, _8]), s = _8.group, _a,
                    ...
                    dojo.forEach(_a, function (c, i) {
                        var _e = typeof _8.data[i] == "number" ? t.post(_9, "marker") : t.addMixin(_9, "marker", _8.data[i], true),
                            _f = "M" + c.x + " " + c.y + " " + _e.symbol;
                        if (_e.marker.shadow) {
            ...
            _animateScatter: function (_15, _16) {
                dojox.gfx.fx.animateTransform(dojo.delegate({
                    shape: _15,
                    duration: 1200,
                    transform: [{name: "translate", start: [0, _16], end: [0, 0]}, {
                        name: "scale",
                        start: [0, 0],
                        end: [1, 1]
                    }, {name: "original"}]
