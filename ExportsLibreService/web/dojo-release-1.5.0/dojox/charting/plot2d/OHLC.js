        ...
        dojo.declare("dojox.charting.plot2d.OHLC", dojox.charting.plot2d.Base, {
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < run.data.length; ++j) {
                        ...
                        if (v !== null) {
                            ...
                            if (_10 >= 1) {
                                var hl = {x1: _10 / 2, x2: _10 / 2, y1: y - _19, y2: y - low}, op = {
                                    x1: 0,
                                    x2: ((_10 / 2) + ((_16.series.stroke.width || 1) / 2)),
                                    y1: y - _17,
                                    y2: y - _17
                                }, cl = {
                                    x1: ((_10 / 2) - ((_16.series.stroke.width || 1) / 2)),
                                    x2: _10,
                                    y1: y - _18,
                                    y2: y - _18
                                };
                                ...
                                if (_13) {
                                    var o = {
                                        ...
                                        cx: _10 / 2,
                                        cy: (y - Math.max(_17, _18)) + (Math.max(_17 > _18 ? _17 - _18 : _18 - _17, 1) / 2),
                                        width: _10,
                                        height: Math.max(_17 > _18 ? _17 - _18 : _18 - _17, 1),
                                        data: v
                                    };
            ...
            _animateOHLC: function (_1b, _1c, _1d) {
                dojox.gfx.fx.animateTransform(dojo.delegate({
                    shape: _1b,
                    duration: 1200,
                    transform: [{name: "translate", start: [0, _1c - (_1c / _1d)], end: [0, 0]}, {
                        name: "scale",
                        start: [1, 1 / _1d],
                        end: [1, 1]
                    }, {name: "original"}]
