...
if (!dojo._hasResource["dojox.charting.plot2d.Bubble"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Bubble", dojox.charting.plot2d.Base, {
            defaultParams: {hAxis: "x", vAxis: "y", animate: null},
            optionalParams: {stroke: {}, outline: {}, shadow: {}, fill: {}, font: "", fontColor: ""},
            ...
            render: function (_4, _5) {
                ...
                var t = this.chart.theme, ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler), _7 = this.events();
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    if (_9.series.shadow) {
                        _d = dojo.map(_a, function (_e) {
                            if (_e !== null) {
                                ...
                                var _11 = s.createCircle({
                                    cx: _e.x + _10.dx,
                                    cy: _e.y + _10.dy,
                                    r: _e.radius
                                }).setStroke(_10).setFill(_10.color);
                                if (this.animate) {
                    ...
                    _b = dojo.map(_a, function (_16) {
                        if (_16 !== null) {
                            var _17 = t.addMixin(_9, "circle", _16, true), _18 = {
                                x: _16.x - _16.radius,
                                y: _16.y - _16.radius,
                                width: 2 * _16.radius,
                                height: 2 * _16.radius
                            ...
                            var _1a = s.createCircle({
                                cx: _16.x,
                                cy: _16.y,
                                r: _16.radius
                            }).setFill(_19).setStroke(_17.series.stroke);
                            if (this.animate) {
            ...
            _animateBubble: function (_1c, _1d, _1e) {
                dojox.gfx.fx.animateTransform(dojo.delegate({
                    shape: _1c,
                    duration: 1200,
                    transform: [{name: "translate", start: [0, _1d], end: [0, 0]}, {
                        name: "scale",
                        start: [0, 1 / _1e],
                        end: [1, 1]
                    }, {name: "original"}]
