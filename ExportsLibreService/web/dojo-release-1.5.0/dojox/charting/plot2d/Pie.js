...
if (!dojo._hasResource["dojox.charting.plot2d.Pie"]) {
    ...
    (function () {
        var df = dojox.lang.functional, du = dojox.lang.utils, dc = dojox.charting.plot2d.common,
            da = dojox.charting.axis2d.common, g = dojox.gfx, m = g.matrix, _1 = 0.2;
        dojo.declare("dojox.charting.plot2d.Pie", [dojox.charting.Element, dojox.charting.plot2d._PlotEvents], {
            ...
            optionalParams: {radius: 0, stroke: {}, outline: {}, shadow: {}, fill: {}, font: "", fontColor: ""},
            constructor: function (_2, _3) {
            ...
            render: function (_6, _7) {
                ...
                var rx = (_6.width - _7.l - _7.r) / 2, ry = (_6.height - _7.t - _7.b) / 2, r = Math.min(rx, ry),
                    _8 = "font" in this.opt ? this.opt.font : t.axis.font,
                    _9 = _8 ? g.normalizedLength(g.splitFontString(_8).size) : 0,
                    _a = "fontColor" in this.opt ? this.opt.fontColor : t.axis.fontColor,
                    _b = m._degToRad(this.opt.startAngle), _c = _b, _d, _e, _f, _10, _11, _12, run = this.run.data,
                    _13 = this.events();
                ...
                dojo.some(_f, function (_19, i) {
                    ...
                    var _1d = end - _c, x1 = _17.cx + r * Math.cos(_c), y1 = _17.cy + r * Math.sin(_c),
                        x2 = _17.cx + r * Math.cos(end), y2 = _17.cy + r * Math.sin(end);
                    ...
                    if (_1a.series.fill && _1a.series.fill.type === "radial" && this.opt.radGrad === "fan" && _1d > _1e) {
                        ...
                        _1b = this._shapeFill(_1a.series.fill, {
                            x: _17.cx - _17.r,
                            y: _17.cy - _17.r,
                            width: 2 * _17.r,
                            height: 2 * _17.r
                        ...
                        for (var j = 0; j < _20; ++j) {
                            var _22 = j == 0 ? x1 : _17.cx + r * Math.cos(_c + (j - _1) * _21),
                                _23 = j == 0 ? y1 : _17.cy + r * Math.sin(_c + (j - _1) * _21),
                                _24 = j == _20 - 1 ? x2 : _17.cx + r * Math.cos(_c + (j + 1 + _1) * _21),
                                _25 = j == _20 - 1 ? y2 : _17.cy + r * Math.sin(_c + (j + 1 + _1) * _21),
                                fan = _1f.createPath({}).moveTo(_17.cx, _17.cy).lineTo(_22, _23).arcTo(r, r, 0, _21 > Math.PI, true, _24, _25).lineTo(_17.cx, _17.cy).closePath().setFill(this._pseudoRadialFill(_1b, {
                                    x: _17.cx,
                                    y: _17.cy
                                }, r, _c + (j + 0.5) * _21, _c + (j + 0.5) * _21));
                        }
                ...
                if (this.opt.labels) {
                    ...
                    dojo.some(_f, function (_26, i) {
                        ...
                        if (_26 >= 1) {
                            var v = run[i],
                                _28 = da.createText[this.opt.htmlLabels && dojox.gfx.renderer != "vml" ? "html" : "gfx"](this.chart, s, _17.cx, _17.cy + _9 / 2, "middle", _10[i], _27.series.font, _27.series.fontColor);
                        ...
                        var _29 = (_c + end) / 2, x = _17.cx + _12 * Math.cos(_29),
                            y = _17.cy + _12 * Math.sin(_29) + _9 / 2;
