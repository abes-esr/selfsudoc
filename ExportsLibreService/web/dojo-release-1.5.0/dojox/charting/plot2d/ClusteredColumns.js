    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.ClusteredColumns", dojox.charting.plot2d.Columns, {
            render: function (_2, _3) {
                ...
                var t = this.chart.theme, f, _5, _6, _7,
                    ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler),
                    _8 = Math.max(0, this._vScaler.bounds.lower), _9 = vt(_8), _a = this.events();
                ...
                for (var i = 0; i < this.series.length; ++i) {
                    ...
                    for (var j = 0; j < _b.data.length; ++j) {
                        var _f = _b.data[j];
                        if (_f !== null) {
                            var v = typeof _f == "number" ? _f : _f.y, vv = vt(v), _10 = vv - _9, h = Math.abs(_10),
                                _11 = typeof _f != "number" ? t.addMixin(_d, "column", _f, true) : t.post(_d, "column");
                            if (_6 >= 1 && h >= 1) {
                                var _12 = {
                                    x: _3.l + ht(j + 0.5) + _5 + _c,
                                    y: _2.height - _3.b - (v > _8 ? vv : _9),
                                    width: _6,
                                    height: h
                                };
