    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Grid", dojox.charting.Element, {
            defaultParams: {
                ...
                vStripes: "none",
                animate: null
            }, optionalParams: {}, constructor: function (_1, _2) {
                ...
                var vs = this._vAxis.scale || 1, hs = this._hAxis.scale || 1, _7 = _5.height - _6.b,
                    _8 = this._hAxis.getScaler().bounds, _9 = (_8.from - _8.lower) * _8.scale,
                    _a = this._vAxis.getScaler().bounds, _b = (_a.from - _a.lower) * _a.scale;
                rVScale = vs / this.lastWindow.vscale, rHScale = hs / this.lastWindow.hscale, rXOffset = (this.lastWindow.xoffset - _9) / ((this.lastWindow.hscale == 1) ? hs : this.lastWindow.hscale), rYOffset = (_b - this.lastWindow.yoffset) / ((this.lastWindow.vscale == 1) ? vs : this.lastWindow.vscale), shape = this.group, anim = dojox.gfx.fx.animateTransform(dojo.delegate({
                    ...
                    transform: [{
                        name: "translate",
                        start: [0, 0],
                        end: [_6.l * (1 - rHScale), _7 * (1 - rVScale)]
                    }, {name: "scale", start: [1, 1], end: [rHScale, rVScale]}, {name: "original"}, {
                        name: "translate",
                        start: [0, 0],
                        end: [rXOffset, rYOffset]
                    }]
                }, this.zoom));
                ...
                try {
                    var _e = this._vAxis.getScaler(), vt = _e.scaler.getTransformerFromModel(_e),
                        _f = this._vAxis.getTicks();
                    if (this.opt.hMinorLines) {
                        dojo.forEach(_f.minor, function (_10) {
                            var y = _c.height - _d.b - vt(_10.value);
                            var _11 = s.createLine({
                                x1: _d.l,
                                y1: y,
                                x2: _c.width - _d.r,
                                y2: y
                ...
                try {
                    var _14 = this._hAxis.getScaler(), ht = _14.scaler.getTransformerFromModel(_14),
                        _f = this._hAxis.getTicks();
                    if (_f && this.opt.vMinorLines) {
                        dojo.forEach(_f.minor, function (_15) {
                            var x = _d.l + ht(_15.value);
                            var _16 = s.createLine({
                                x1: x,
                                y1: _d.t,
                                x2: x,
                                y2: _c.height - _d.b
                ...
                dojox.gfx.fx.animateTransform(dojo.delegate({
                    shape: _19,
                    duration: 1200,
                    transform: [{name: "translate", start: _1d, end: [0, 0]}, {
                        name: "scale",
                        start: _1e,
                        end: [1, 1]
                    }, {name: "original"}]
