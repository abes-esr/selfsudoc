...
if (!dojo._hasResource["dojox.charting.plot2d.Columns"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.Columns", dojox.charting.plot2d.Base, {
            defaultParams: {hAxis: "x", vAxis: "y", gap: 0, animate: null},
            optionalParams: {
                minBarSize: 1,
                maxBarSize: 1,
                stroke: {},
            ...
            render: function (_5, _6) {
                ...
                var t = this.chart.theme, f, _8, _9, ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler),
                    _a = Math.max(0, this._vScaler.bounds.lower), _b = vt(_a), _c = this.events();
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < _d.data.length; ++j) {
                        var _10 = _d.data[j];
                        if (_10 !== null) {
                            var v = typeof _10 == "number" ? _10 : _10.y, vv = vt(v), _11 = vv - _b, h = Math.abs(_11),
                                _12 = typeof _10 != "number" ? t.addMixin(_e, "column", _10, true) : t.post(_e, "column");
                            if (_9 >= 1 && h >= 1) {
                                var _13 = {
                                    x: _6.l + ht(j + 0.5) + _8,
                                    y: _5.height - _6.b - (v > _a ? vv : _b),
                                    width: _9,
                                    height: h
                                };
            ...
            _animateColumn: function (_16, _17, _18) {
                dojox.gfx.fx.animateTransform(dojo.delegate({
                    shape: _16,
                    duration: 1200,
                    transform: [{name: "translate", start: [0, _17 - (_17 / _18)], end: [0, 0]}, {
                        name: "scale",
                        start: [1, 1 / _18],
                        end: [1, 1]
                    }, {name: "original"}]
