    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot2d.StackedColumns", dojox.charting.plot2d.Columns, {
            getSeriesStats: function () {
                ...
                var t = this.chart.theme, f, _9, _a, ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler), _b = this.events();
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < _5.length; ++j) {
                        ...
                        if (_7 !== null) {
                            var v = _5[j], _e = vt(v),
                                _f = typeof _7 != "number" ? t.addMixin(_c, "column", _7, true) : t.post(_c, "column");
                            if (_a >= 1 && _e >= 1) {
                                var _10 = {
                                    x: _4.l + ht(j + 0.5) + _9,
                                    y: _3.height - _4.b - vt(v),
                                    width: _a,
                                    height: _e
                                };
