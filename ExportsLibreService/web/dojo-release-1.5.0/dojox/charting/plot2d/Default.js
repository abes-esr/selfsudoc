        ...
        dojo.declare("dojox.charting.plot2d.Default", dojox.charting.plot2d.Base, {
            ...
            render: function (_5, _6) {
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    var _d = t.next(this.opt.areas ? "area" : "line", [this.opt, _c], true), s = _c.group, _e = [],
                        _f = [], _10 = null, _11, ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                        vt = this._vScaler.scaler.getTransformerFromModel(this._vScaler),
                        _12 = this._eventSeries[_c.name] = new Array(_c.data.length);
                ...
                if (this.animate) {
                    ...
                    dojox.gfx.fx.animateTransform(dojo.delegate({
                        shape: _1d,
                        duration: _2,
                        transform: [{name: "translate", start: [0, _5.height - _6.b], end: [0, 0]}, {
                            name: "scale",
                            start: [1, 0],
                            end: [1, 1]
                        }, {name: "original"}]
