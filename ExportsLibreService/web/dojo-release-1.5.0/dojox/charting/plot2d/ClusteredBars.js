        ...
        dojo.declare("dojox.charting.plot2d.ClusteredBars", dojox.charting.plot2d.Bars, {
            render: function (_2, _3) {
                ...
                var t = this.chart.theme, f, _5, _6, _7,
                    ...
                    _8 = Math.max(0, this._hScaler.bounds.lower), _9 = ht(_8), _a = this.events();
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < _b.data.length; ++j) {
                        var _f = _b.data[j];
                        if (_f !== null) {
                            var v = typeof _f == "number" ? _f : _f.y, hv = ht(v), _10 = hv - _9, w = Math.abs(_10),
                                _11 = typeof _f != "number" ? t.addMixin(_d, "bar", _f, true) : t.post(_d, "bar");
                            if (w >= 1 && _6 >= 1) {
                                var _12 = {
                                    x: _3.l + (v < _8 ? hv : _9),
                                    y: _2.height - _3.b - vt(j + 1.5) + _5 + _c,
                                    width: w,
                                    height: _6
                                };
