        ...
        dojo.declare("dojox.charting.plot2d.Bars", dojox.charting.plot2d.Base, {
            ...
            render: function (_5, _6) {
                ...
                var t = this.chart.theme, f, _8, _9, ht = this._hScaler.scaler.getTransformerFromModel(this._hScaler),
                    ...
                    _a = Math.max(0, this._hScaler.bounds.lower), _b = ht(_a), _c = this.events();
                ...
                for (var i = this.series.length - 1; i >= 0; --i) {
                    ...
                    for (var j = 0; j < _d.data.length; ++j) {
                        var _10 = _d.data[j];
                        if (_10 !== null) {
                            var v = typeof _10 == "number" ? _10 : _10.y, hv = ht(v), _11 = hv - _b, w = Math.abs(_11),
                                _12 = typeof _10 != "number" ? t.addMixin(_e, "bar", _10, true) : t.post(_e, "bar");
                            if (w >= 1 && _9 >= 1) {
                                var _13 = {
                                    x: _6.l + (v < _a ? hv : _b),
                                    y: _5.height - _6.b - vt(j + 1.5) + _8,
                                    width: w,
                                    height: _9
                                };
            ...
            _animateBar: function (_16, _17, _18) {
                dojox.gfx.fx.animateTransform(dojo.delegate({
                    shape: _16,
                    duration: 1200,
                    transform: [{name: "translate", start: [_17 - (_17 / _18), 0], end: [0, 0]}, {
                        name: "scale",
                        start: [1 / _18, 1],
                        end: [1, 1]
                    }, {name: "original"}]
