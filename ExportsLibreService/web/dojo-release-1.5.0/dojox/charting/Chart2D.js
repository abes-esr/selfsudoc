...
if (!dojo._hasResource["dojox.charting.Chart2D"]) {
    ...
    (function () {
        var df = dojox.lang.functional, dc = dojox.charting, _1 = df.lambda("item.clear()"),
            _2 = df.lambda("item.purgeGroup()"), _3 = df.lambda("item.destroy()"), _4 = df.lambda("item.dirty = false"),
            _5 = df.lambda("item.dirty = true"), _6 = df.lambda("item.name");
            ...
            constructor: function (_7, _8) {
                ...
                if (_60) {
                    this.surface.createRect({
                        x: _5f.l - 1,
                        y: _5f.t - 1,
                        width: dim.width - _5f.l - _5f.r + 2,
                        height: dim.height - _5f.t - _5f.b + 2
                    }).setFill(_60);
                }
                if (_61) {
                    this.surface.createRect({
                        x: _5f.l,
                        y: _5f.t,
                        width: dim.width - _5f.l - _5f.r + 1,
                        height: dim.height - _5f.t - _5f.b + 1
                    }).setStroke(_61);
                }
