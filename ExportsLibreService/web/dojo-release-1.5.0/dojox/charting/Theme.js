...
if (!dojo._hasResource["dojox.charting.Theme"]) {
    ...
    dojo.declare("dojox.charting.Theme", null, {
        shapeSpaces: {shape: 1, shapeX: 1, shapeY: 1}, constructor: function (_1) {
            _1 = _1 || {};
            ...
            var _4 = new dojox.charting.Theme({
                chart: this.chart,
    ...
    dojo.mixin(dojox.charting.Theme, {
        ...
        defaultTheme: {
            chart: {stroke: null, fill: "white", pageStyle: null},
            plotarea: {stroke: null, fill: "white"},
            axis: {
                stroke: {color: "#333", width: 1},
                tick: {color: "#666", position: "center", font: "normal normal normal 7pt Tahoma", fontColor: "#333"},
        ...
        generateHslGradient: function (_28, _29, _2a, _2b) {
            ...
            var hsl = _28.toHsl(), _2c = dojox.color.fromHsl(hsl.h, hsl.s, _2a),
                _2d = dojox.color.fromHsl(hsl.h, hsl.s, _2b);
            _2c.a = _2d.a = _28.a;
