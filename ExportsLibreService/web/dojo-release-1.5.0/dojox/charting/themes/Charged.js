...
if (!dojo._hasResource["dojox.charting.themes.Charged"]) {
    ...
    (function () {
        var dc = dojox.charting, _1 = dc.themes, _2 = dc.Theme, g = _2.generateGradient,
            _3 = {type: "linear", space: "shape", x1: 0, y1: 0, x2: 0, y2: 75};
        _1.Charged = new dc.Theme({
            chart: {
                fill: "#ededdf",
            ...
            seriesThemes: [{fill: g(_3, "#004cbf", "#06f")}, {fill: g(_3, "#bf004c", "#f06")}, {fill: g(_3, "#43bf00", "#6f0")}, {fill: g(_3, "#7300bf", "#90f")}, {fill: g(_3, "#bf7300", "#f90")}, {fill: g(_3, "#00bf73", "#0f9")}],
            markerThemes: [{fill: "#06f", stroke: {color: "#06f"}}, {
                fill: "#f06",
                stroke: {color: "#f06"}
            }, {fill: "#6f0", stroke: {color: "#6f0"}}, {fill: "#90f", stroke: {color: "#90f"}}, {
                fill: "#f90",
                stroke: {color: "#f90"}
