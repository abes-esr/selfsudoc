...
if (!dojo._hasResource["dojox.charting.themes.Tom"]) {
    ...
    (function () {
        ...
        _1.Tom = new dc.Theme({
            ...
            plotarea: {fill: "#181818"},
            axis: {
                stroke: {color: "#a0a68b", width: 1},
                tick: {
                    color: "#888c76",
                    position: "center",
            ...
            seriesThemes: [{fill: g(_3, "#bf9e0a", "#ecc20c")}, {fill: g(_3, "#73b086", "#95e5af")}, {fill: g(_3, "#c7212d", "#ed2835")}, {fill: g(_3, "#87ab41", "#b6e557")}, {fill: g(_3, "#b86c25", "#d37d2a")}],
            markerThemes: [{fill: "#bf9e0a", stroke: {color: "#ecc20c"}}, {
                fill: "#73b086",
                stroke: {color: "#95e5af"}
