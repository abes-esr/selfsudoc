    ...
    (function () {
        ...
        dojo.declare("dojox.charting.plot3d.Bars", dojox.charting.plot3d.Base, {
            constructor: function (_2, _3, _4) {
                ...
                var _7 = this.width / this.data.length, _8 = 0,
                    _9 = this.depth == "auto" ? _7 - 2 * this.gap : this.depth,
                    _a = this.height / _1(this.data, Math.max);
                if (!_6) {
                    _6 = _5.view;
                }
                for (var i = 0; i < this.data.length; ++i, _8 += _7) {
                    _6.createCube({
                        bottom: {x: _8 + this.gap, y: 0, z: 0},
                        top: {x: _8 + _7 - this.gap, y: this.data[i] * _a, z: _9}
