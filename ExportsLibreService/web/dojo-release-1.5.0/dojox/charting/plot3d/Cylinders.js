        ...
        dojo.declare("dojox.charting.plot3d.Cylinders", dojox.charting.plot3d.Base, {
            constructor: function (_2, _3, _4) {
                ...
                for (var i = 0; i < this.data.length; ++i, _8 += _7) {
                    _6.createCylinder({
                        center: {x: _8 + _7 / 2, y: 0, z: 0},
                        radius: _7 / 2 - this.gap,
                        height: this.data[i] * _9
                    }).setTransform(dojox.gfx3d.matrix.rotateXg(-90)).setFill(this.material).setStroke(this.outline);
                }
            }
        });
    })();
