...
if (!dojo._hasResource["dojox.charting.action2d.MoveSlice"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.charting.action2d.MoveSlice", dojox.charting.action2d.Base, {
            defaultParams: {duration: 400, easing: dojo.fx.easing.backOut, scale: _1, shift: _2},
            optionalParams: {},
            ...
            process: function (o) {
                ...
                var _7 = o.index, _8, _9, _a, _b, _c, _d = (this.angles[_7] + this.angles[_7 + 1]) / 2,
                    _e = m.rotateAt(-_d, o.cx, o.cy), _f = m.rotateAt(_d, o.cx, o.cy);
                _8 = this.anim[_7];
                if (_8) {
                    _8.action.stop(true);
                } else {
                ...
                _8.action = dojox.gfx.fx.animateTransform({
                    shape: o.shape,
                    duration: this.duration,
                    easing: this.easing,
                    transform: [_f, {name: "translate", start: [_b, 0], end: [_c, 0]}, {
                        name: "scaleAt",
                        start: [_9, o.cx, o.cy],
                        end: [_a, o.cx, o.cy]
                    }, _e]
