...
if (!dojo._hasResource["dojox.charting.action2d.Tooltip"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.charting.action2d.Tooltip", dojox.charting.action2d.Base, {
            defaultParams: {text: _1}, optionalParams: {}, constructor: function (_4, _5, _6) {
                ...
                switch (o.element) {
                    ...
                    default:
                        ...
                        var _a = m._degToRad(o.plot.opt.startAngle),
                            _b = (this.angles[o.index] + this.angles[o.index + 1]) / 2 + _a;
        ...
        var _d = dojo.declare(dijit._MasterTooltip, {
            show: function (_e, _f, _10, _11) {
                ...
                for (var _1d in _1a) {
                    _1c.push({
                        ...
                        corner: _1a[_1d],
                        pos: {
                            x: x + (_1d.charAt(1) == "L" ? 0 : _18),
                            y: y + (_1d.charAt(0) == "T" ? 0 : _19),
                            w: _18,
                            h: _19
                        }
                    });
