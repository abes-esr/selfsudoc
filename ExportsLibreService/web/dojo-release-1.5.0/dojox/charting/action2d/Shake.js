...
if (!dojo._hasResource["dojox.charting.action2d.Shake"]) {
    ...
    (function () {
        ...
        dojo.declare("dojox.charting.action2d.Shake", dojox.charting.action2d.Base, {
            defaultParams: {duration: 400, easing: dojo.fx.easing.backOut, shiftX: _1, shiftY: _1},
            optionalParams: {},
            constructor: function (_2, _3, _4) {
                if (!_4) {
                    _4 = {};
                }
            ...
            process: function (o) {
                ...
                var _5 = o.run.name, _6 = o.index, _7 = [], _8,
                    _9 = o.type == "onmouseover" ? this.shiftX : -this.shiftX,
                    _a = o.type == "onmouseover" ? this.shiftY : -this.shiftY;
                if (_5 in this.anim) {
                    _8 = this.anim[_5][_6];
                } else {
                    this.anim[_5] = {};
                ...
                var _b = {
                    ...
                    easing: this.easing,
                    transform: [{name: "translate", start: [this.shiftX, this.shiftY], end: [0, 0]}, m.identity]
                };
                if (o.shape) {
