...
if (!dojo._hasResource["dojox.storage.AirEncryptedLocalStorageProvider"]) {
    ...
    if (dojo.isAIR) {
        (function () {
            ...
            _1.EncryptedLocalStore = window.runtime.flash.data.EncryptedLocalStore, dojo.declare("dojox.storage.AirEncryptedLocalStorageProvider", [dojox.storage.Provider], {
                initialize: function () {
