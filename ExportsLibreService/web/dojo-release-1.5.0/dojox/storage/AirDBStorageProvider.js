        ...
        (function () {
            ...
            dojo.declare("dojox.storage.AirDBStorageProvider", [dojox.storage.Provider], {
                ...
                get: function (_a, _b) {
                    ...
                    var _c = this._sql("SELECT * FROM " + this.TABLE_NAME + " WHERE namespace = :namespace AND key = :key", {
                        ":namespace": _b,
                        ":key": _a
                    });
                ...
                getMultiple: function (_16, _17) {
                    ...
                    for (var i = 0; i < _16.length; i++) {
                        var _19 = this._sql("SELECT * FROM " + this.TABLE_NAME + " WHERE namespace = :namespace AND key = :key", {
                            ":namespace": _17,
                            ":key": _16[i]
                        });
