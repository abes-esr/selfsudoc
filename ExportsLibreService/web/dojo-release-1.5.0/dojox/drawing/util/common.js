    ...
    (function () {
        ...
        dojox.drawing.util.common = {
            radToDeg: function (n) {
                ...
                var _13 = this.radians(obj), _14 = this.length(obj), seg = Math.PI * ca, rnd = Math.round(_13 / seg),
                    _15 = rnd * seg, _16 = this.radToDeg(_15),
                    pt = this.pointOnCircle(obj.start.x, obj.start.y, _14, _16);
                return pt;
