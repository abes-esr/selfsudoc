    ...
    dojo.declare("dojox.drawing.ui.Toolbar", [], {
        ...
        makeButtons: function () {
            ...
            var x = this.padding, y = this.padding, w = this.size, h = this.size, r = this.radius, g = this.margin,
                _4 = dojox.drawing.library.icons, s = {place: "BR", size: 2, mult: 4};
            if (this.strTools) {
                var _5 = [];
                ...
                dojo.forEach(_5, function (t) {
                    ...
                    if (t.indexOf("Secondary") > -1) {
                        ...
                        var btn = this.toolDrawing.addUI("button", {
                            data: {x: x, y: y, width: w, height: h / 2, r: r},
                            toolType: t,
                            secondary: true,
                            text: _10,
                            shadow: s,
                        ...
                        var btn = this.toolDrawing.addUI("button", {
                            data: {x: x, y: y, width: w, height: h, r: r},
                            toolType: t,
                            icon: _4[t],
                            shadow: s,
                            scope: this,
            ...
            if (this.strPlugs) {
                ...
                dojo.forEach(_12, function (p) {
                    ...
                    var _16 = {};
                    _14[p].button == false ? _16 = {name: this.drawing.stencilTypeMap[p]} : _16 = {
                        name: this.drawing.stencilTypeMap[p],
                        options: {button: btn}
                    };
