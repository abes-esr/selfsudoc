...
if (!dojo._hasResource["dojox.drawing.manager.Anchors"]) {
    ...
    dojox.drawing.manager.Anchors = dojox.drawing.util.oo.declare(function (_1) {
        ...
        onAddAnchor: function (_2) {
            ...
            dojo.forEach(_d, function (p, i) {
                ...
                var a = new dojox.drawing.manager.Anchor({
                    stencil: _c,
                    point: p,
                    pointIdx: i,
                    mouse: this.mouse,
    ...
    dojox.drawing.manager.Anchor = dojox.drawing.util.oo.declare(function (_10) {
        ...
        y_anchor: null, x_anchor: null, render: function () {
            ...
            var d = this.defaults.anchors, z = this.mouse.zoom, b = d.width * z, s = d.size * z, p = s / 2,
                _11 = {width: b, style: d.style, color: d.color, cap: d.cap};
            ...
            if (this.selected) {
                ...
                var _16 = pmx.dx + this.org.x, _17 = pmx.dy + this.org.y, x = obj.x - _16, y = obj.y - _17,
