    ...
    dojo.declare("dojo.dnd.Avatar", null, {
        constructor: function (_1) {
            ...
            var a = dojo.create("table", {
                ...
                }), _2 = this.manager.source, _3, b = dojo.create("tbody", null, a), tr = dojo.create("tr", null, b),
                td = dojo.create("td", null, tr), _4 = this.isA11y ? dojo.create("span", {
                    id: "a11yIcon",
                    innerHTML: this.manager.copy ? "+" : "<"
                }, td) : null, _5 = dojo.create("span", {innerHTML: _2.generateText ? this._generateText() : ""}, td),
