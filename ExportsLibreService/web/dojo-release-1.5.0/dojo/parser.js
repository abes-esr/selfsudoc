...
if (!dojo._hasResource["dojo.parser"]) {
    ...
    dojo.parser = new function () {
        ...
        this.instantiate = function (_16, _17, _18) {
            ...
            d.forEach(_16, function (obj) {
                ...
                d.forEach(_1e, function (_27) {
                    _1a.removeChild(_27);
                    var _28 = _27.getAttribute("event"), _1b = _27.getAttribute("type"),
                        nf = d.parser._functionFromScript(_27);
                    if (_28) {
                        if (_1b == "dojo/connect") {
        ...
        this.parse = function (_2f, _30) {
            ...
            var _3d = [];
            _33({
                node: _31 ? dojo.byId(_31) : dojo.body(),
                inherited: (_30 && _30.inherited) || {dir: dojo._isBodyLtr() ? "ltr" : "rtl"}
            }, _3d);
