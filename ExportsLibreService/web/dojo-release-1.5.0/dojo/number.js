...
if (!dojo._hasResource["dojo.number"]) {
    ...
    dojo.number._applyPattern = function (_6, _7, _8) {
        ...
        return _7.replace(_f, dojo.number._formatAbsolute(_6, _10[0], {
            decimal: _a,
            group: _9,
            places: _8.places,
            round: _8.round
    ...
    dojo.number._parseInfo = function (_26) {
        _26 = _26 || {};
        var _27 = dojo.i18n.normalizeLocale(_26.locale), _28 = dojo.i18n.getLocalization("dojo.cldr", "number", _27),
            _29 = _26.pattern || _28[(_26.type || "decimal") + "Format"], _2a = _28.group, _2b = _28.decimal, _2c = 1;
        if (_29.indexOf("%") != -1) {
            _2c /= 100;
        } else {
            if (_29.indexOf("‰") != -1) {
        ...
        var re = dojo.regexp.buildGroupRE(_2e, function (_2f) {
            ...
            return _2f.replace(dojo.number._numberPatternRE, function (_30) {
                var _31 = {
                    signed: false,
                    separator: _26.strict ? _2a : [_2a, ""],
                    fractional: _26.fractional,
                    decimal: _2b,
                    exponent: false
                }, _32 = _30.split("."), _33 = _26.places;
        ...
        if (_2d) {
            re = re.replace(/([\s\xa0]*)(\u00a4{1,3})([\s\xa0]*)/g, function (_35, _36, _37, _38) {
                var _39 = ["symbol", "currency", "displayName"][_37.length - 1],
                    _3a = dojo.regexp.escapeString(_26[_39] || _26.currency || "");
                _36 = _36 ? "[\\s\\xa0]" : "";
                _38 = _38 ? "[\\s\\xa0]" : "";
                if (!_26.strict) {
                    if (_36) {
