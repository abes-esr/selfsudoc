...
if (!dojo._hasResource["dojo.date.locale"]) {
    ...
    (function () {
        ...
        dojo.date.locale.format = function (_11, _12) {
            _12 = _12 || {};
            var _13 = dojo.i18n.normalizeLocale(_12.locale), _14 = _12.formatLength || "short",
                _15 = dojo.date.locale._getGregorianBundle(_13), str = [], _16 = dojo.hitch(this, _1, _11, _15, _12);
        ...
        dojo.date.locale._parseInfo = function (_1b) {
            _1b = _1b || {};
            var _1c = dojo.i18n.normalizeLocale(_1b.locale), _1d = dojo.date.locale._getGregorianBundle(_1c),
                _1e = _1b.formatLength || "short", _1f = _1b.datePattern || _1d["dateFormat-" + _1e],
                _20 = _1b.timePattern || _1d["timeFormat-" + _1e], _21;
        ...
        dojo.date.locale.parse = function (_25, _26) {
            var _27 = dojo.date.locale._parseInfo(_26), _28 = _27.tokens, _29 = _27.bundle,
                re = new RegExp("^" + _27.regexp + "$", _27.strict ? "" : "i"), _2a = re.exec(_25);
            if (!_2a) {
                return null;
            }
            var _2b = ["abbr", "wide", "narrow"], _2c = [1970, 0, 1, 0, 0, 0, 0], _2d = "",
                _2e = dojo.every(_2a, function (v, i) {
                    if (!i) {
                        return true;
                    }
                    var _2f = _28[i - 1];
                    ...
                    switch (_2f.charAt(0)) {
                        case "y":
                            if (l != 2 && _26.strict) {
                                ...
                                if (v < 100) {
                                    v = Number(v);
                                    var _30 = "" + new Date().getFullYear(), _31 = _30.substring(0, 2) * 100,
                                        _32 = Math.min(Number(_30.substring(2, 4)) + 20, 99),
                                        num = (v < _32) ? _31 + v : _31 - 100 + v;
                                    _2c[0] = num;
                                } else {
                                    if (_26.strict) {
                                        return false;
                        ...
                        case "d":
                            ...
                            break;
                        case "a":
                            var am = _26.am || _29["dayPeriods-format-wide-am"],
                                pm = _26.pm || _29["dayPeriods-format-wide-pm"];
                            if (!_26.strict) {
                                var _35 = /\./g;
            ...
            return _46.replace(/([a-z])\1*/ig, function (_47) {
                ...
                switch (c) {
                    ...
                    case "S":
                        ...
                        break;
                    case "a":
                        var am = _45.am || _44["dayPeriods-format-wide-am"],
                            pm = _45.pm || _44["dayPeriods-format-wide-pm"];
                        if (_45.strict) {
                            s = am + "|" + pm;
                        } else {
                            s = am + "|" + pm;
    ...
    dojo.date.locale._getWeekOfYear = function (_5a, _5b) {
        ...
        var _5c = new Date(_5a.getFullYear(), 0, 1).getDay(), adj = (_5c - _5b + 7) % 7,
            _5d = Math.floor((dojo.date.locale._getDayOfYear(_5a) + adj - 1) / 7);
        if (_5c == _5b) {
            _5d++;
        }
        return _5d;
