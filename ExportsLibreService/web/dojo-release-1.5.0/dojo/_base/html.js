...
if (!dojo._hasResource["dojo._base.html"]) {
    ...
    (function () {
        ...
        dojo._getBorderExtents = function (n, _35) {
            var ne = "none", s = _35 || gcs(n), bl = (s.borderLeftStyle != ne ? px(n, s.borderLeftWidth) : 0),
        ...
        dojo._getMarginExtents = function (n, _37) {
            var s = _37 || gcs(n), l = px(n, s.marginLeft), t = px(n, s.marginTop), r = px(n, s.marginRight),
        ...
        dojo._getContentBox = function (_3a, _3b) {
            var s = _3b || gcs(_3a), pe = d._getPadExtents(_3a, s), be = d._getBorderExtents(_3a, s),
                w = _3a.clientWidth, h;
            if (!w) {
        ...
        var _5c = {
                ...
                rowspan: "rowSpan",
                valuetype: "valueType"
            }, _5d = {classname: "class", htmlfor: "for", tabindex: "tabIndex", readonly: "readOnly"},
            _5e = {innerHTML: 1, className: 1, htmlFor: d.isIE, value: 1};
        ...
        var _67 = {}, _68 = 0, _69 = dojo._scopeName + "attrid",
            _6a = {col: 1, colgroup: 1, table: 1, tbody: 1, tfoot: 1, thead: 1, tr: 1, title: 1};
        ...
        var _7e = {
            ...
            col: ["table", "colgroup"],
            li: ["ul"]
        }, _7f = /<\s*([\w\:]+)/, _80 = {}, _81 = 0, _82 = "__" + d._scopeName + "ToDomId";
        for (var _83 in _7e) {
            var tw = _7e[_83];
