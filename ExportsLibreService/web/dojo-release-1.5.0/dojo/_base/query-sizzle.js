...
if (!dojo._hasResource["dojo._base.query"]) {
    ...
    (function (ns) {
        var _6 = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^[\]]*\]|[^[\]]+)+\]|\\.|[^ >+~,(\[]+)+|[>+~])(\s*,\s*)?/g,
            _7 = 0, _8 = Object.prototype.toString;
        var _9 = function (_a, _b, _c, _d) {
            ...
            if (_e.length > 1 && _15.match.POS.exec(_a)) {
                ...
                var ret = _d ? {
                    expr: _e.pop(),
                    set: _19(_d)
                } : _9.find(_e.pop(), _e.length === 1 && _b.parentNode ? _b.parentNode : _b);
        ...
        var _15 = _9.selectors = {
            ...
            preFilter: {
                CLASS: function (_49, _4a, _4b, _4c, not) {
                    _49 = " " + _49[1].replace(/\\/g, "") + " ";
                    for (var i = 0; _4a[i]; i++) {
