...
if (!dojo._hasResource["dojo._base.event"]) {
    ...
    (function () {
        var _1 = (dojo._event_listener = {
            add: function (_2, _3, fp) {
                if (!_2) {
                    return;
                }
        ...
        if (dojo.isIE) {
            dojo.mouseButtons = {
                LEFT: 1, MIDDLE: 4, RIGHT: 2, isButton: function (e, _1a) {
                    return e.button & _1a;
                }, isLeft: function (e) {
                    return e.button & 1;
                }, isMiddle: function (e) {
            ...
            dojo.mouseButtons = {
                LEFT: 0, MIDDLE: 1, RIGHT: 2, isButton: function (e, _1b) {
                    return e.button == _1b;
                }, isLeft: function (e) {
                    return e.button == 0;
                }, isMiddle: function (e) {
        ...
        if (dojo.isIE) {
            ...
            if (!dojo.config._allow_leaks) {
                _10 = iel = dojo._ie_listener = {
                    handlers: [], add: function (_1f, _20, _21) {
                        _1f = _1f || dojo.global;
                        var f = _1f[_20];
                        if (!f || !f[_1e]) {
    ...
    if (dojo.isIE) {
        dojo._ieDispatcher = function (_3c, _3d) {
            var ap = Array.prototype, h = dojo._ie_listener.handlers, c = _3c.callee, ls = c[dojo._ieListenersName],
                t = h[c.target];
